...
include::ROOT:partial$developer-cli-odo-listing-available-services-from-the-operators-installed-on-the-cluster.adoc[leveloffset=+1]
include::ROOT:partial$developer-cli-odo-creating-a-service-from-an-operator.adoc[leveloffset=+1]
include::ROOT:partial$developer-cli-odo-creating-services-from-yaml-files.adoc[leveloffset=+1]
