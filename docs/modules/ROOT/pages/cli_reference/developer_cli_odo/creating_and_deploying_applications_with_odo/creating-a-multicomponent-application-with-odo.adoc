...
include::ROOT:partial$developer-cli-odo-deploying-the-back-end-component.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-deploying-the-front-end-component.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-linking-both-components.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-exposing-the-components-to-the-public.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-modifying-the-running-application.adoc[leveloffset=+1]
