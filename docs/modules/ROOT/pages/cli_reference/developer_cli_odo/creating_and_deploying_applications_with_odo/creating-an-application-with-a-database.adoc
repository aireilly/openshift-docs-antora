...
include::ROOT:partial$developer-cli-odo-deploying-a-database-in-interactive-mode.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-deploying-a-database-manually.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-connecting-the-database.adoc[leveloffset=+1]
