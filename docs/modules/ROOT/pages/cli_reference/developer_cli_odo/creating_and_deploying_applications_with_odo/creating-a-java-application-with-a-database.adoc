...
include::ROOT:partial$developer-cli-odo-creating-a-java-microservice-jpa-application.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-creating-a-database-with-odo.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-connecting-a-java-application-to-mysql-database.adoc[leveloffset=+1]
