...
include::ROOT:partial$developer-cli-odo-about-devfiles-in-odo.adoc[leveloffset=+1]
...
include::ROOT:partial$developer-cli-odo-creating-a-project.adoc[leveloffset=+2]

include::ROOT:partial$developer-cli-odo-listing-available-devfile-components.adoc[leveloffset=+2]

include::ROOT:partial$developer-cli-odo-deploying-a-java-application-using-a-devfile.adoc[leveloffset=+2]

include::ROOT:partial$developer-cli-odo-converting-an-s2i-component-into-a-devfile-component.adoc[leveloffset=+1]
