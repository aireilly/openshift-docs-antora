...
include::ROOT:partial$developer-cli-odo-mirroring-a-supported-builder-image.adoc[leveloffset=+1]
include::ROOT:partial$developer-cli-odo-overwriting-a-mirror-registry.adoc[leveloffset=+1]
