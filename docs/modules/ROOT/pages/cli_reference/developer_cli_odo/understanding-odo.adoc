...
include::ROOT:partial$odo-key-features.adoc[leveloffset=+1]
include::ROOT:partial$odo-core-concepts.adoc[leveloffset=+1]
include::ROOT:partial$odo-listing-components.adoc[leveloffset=+1]
include::ROOT:partial$odo-telemetry.adoc[leveloffset=+1]