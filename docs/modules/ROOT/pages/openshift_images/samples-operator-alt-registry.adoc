...
//include::ROOT:partial$installation-local-registry-pull-secret.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-restricted-network-samples.adoc[leveloffset=+1]
