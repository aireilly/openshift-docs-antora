...
include::ROOT:partial$samples-operator-overview.adoc[leveloffset=+1]
...
include::ROOT:partial$samples-operator-configuration.adoc[leveloffset=+1]

include::ROOT:partial$samples-operator-crd.adoc[leveloffset=+1]

include::ROOT:partial$images-samples-operator-deprecated-image-stream.adoc[leveloffset=+1]
