...
include::ROOT:partial$images-triggering-updates-imagestream-changes-kubernetes-about.adoc[leveloffset=+1]

include::ROOT:partial$images-triggering-updates-imagestream-changes-kubernetes-cli.adoc[leveloffset=+1]
