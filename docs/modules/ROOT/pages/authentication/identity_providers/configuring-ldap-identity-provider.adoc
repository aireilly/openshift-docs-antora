...
include::ROOT:partial$identity-provider-about-ldap.adoc[leveloffset=+1]

ifdef::openshift-enterprise,openshift-webscale,openshift-origin[]
include::ROOT:partial$identity-provider-ldap-secret.adoc[leveloffset=+1]

include::ROOT:partial$identity-provider-config-map.adoc[leveloffset=+1]

include::ROOT:partial$identity-provider-ldap-CR.adoc[leveloffset=+1]
