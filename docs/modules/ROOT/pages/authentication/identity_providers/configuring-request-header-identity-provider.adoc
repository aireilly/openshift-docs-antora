...
include::ROOT:partial$identity-provider-about-request-header.adoc[leveloffset=+1]

include::ROOT:partial$identity-provider-config-map.adoc[leveloffset=+1]

include::ROOT:partial$identity-provider-request-header-CR.adoc[leveloffset=+1]
...
[discrete]
include::ROOT:partial$identity-provider-apache-custom-proxy-configuration.adoc[leveloffset=+2]

[discrete]
include::ROOT:partial$identity-provider-configuring-apache-request-header.adoc[leveloffset=+2]
