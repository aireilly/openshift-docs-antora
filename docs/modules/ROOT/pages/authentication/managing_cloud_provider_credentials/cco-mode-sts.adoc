...
//include::ROOT:partial$sts-mode-installing-manual-config.adoc[leveloffset=+2]
...
include::ROOT:partial$cco-ccoctl-creating-individually.adoc[leveloffset=+3]

//Task part 2b: Creating the required AWS resources all at once
include::ROOT:partial$cco-ccoctl-creating-at-once.adoc[leveloffset=+3]

//Task part 3: Run the OCP installer
include::ROOT:partial$sts-mode-installing-manual-run-installer.adoc[leveloffset=+2]

//Task part 4: Verify that the cluster is using short-lived credentials
include::ROOT:partial$sts-mode-installing-verifying.adoc[leveloffset=+2]
...
include::ROOT:partial$cco-ccoctl-upgrading.adoc[leveloffset=+2]

include::ROOT:partial$manually-maintained-credentials-upgrade.adoc[leveloffset=+2]
