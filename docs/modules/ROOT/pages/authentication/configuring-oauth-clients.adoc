...
include::ROOT:partial$oauth-default-clients.adoc[leveloffset=+1]

// Register an additional OAuth client
include::ROOT:partial$oauth-register-additional-client.adoc[leveloffset=+1]

// Configuring token inactivity timeout for OAuth clients
include::ROOT:partial$oauth-configuring-token-inactivity-timeout-clients.adoc[leveloffset=+1]
