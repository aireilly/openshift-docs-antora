...
include::ROOT:partial$nodes-pods-autoscaling-custom-about.adoc[leveloffset=+1]
...
include::ROOT:partial$nodes-pods-autoscaling-custom-install.adoc[leveloffset=+1]

include::ROOT:partial$nodes-pods-autoscaling-custom-trigger.adoc[leveloffset=+1]
...
include::ROOT:partial$nodes-pods-autoscaling-custom-trigger-auth.adoc[leveloffset=+1]
...
include::ROOT:partial$nodes-pods-autoscaling-custom-creating-trigger-auth.adoc[leveloffset=+2]

include::ROOT:partial$nodes-pods-autoscaling-custom-prometheus-config.adoc[leveloffset=+1]
...
include::ROOT:partial$nodes-pods-autoscaling-custom-adding.adoc[leveloffset=+1]

include::ROOT:partial$nodes-pods-autoscaling-custom-creating-workload.adoc[leveloffset=+2]
...
include::ROOT:partial$nodes-pods-autoscaling-custom-creating-job.adoc[leveloffset=+2]
...
include::ROOT:partial$nodes-pods-autoscaling-custom-uninstalling.adoc[leveloffset=+1]
