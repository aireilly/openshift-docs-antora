...
include::ROOT:partial$nodes-scheduler-taints-tolerations-about.adoc[leveloffset=+1]

include::ROOT:partial$nodes-scheduler-taints-tolerations-adding.adoc[leveloffset=+1]
...
include::ROOT:partial$nodes-scheduler-taints-tolerations-projects.adoc[leveloffset=+2]
...
include::ROOT:partial$nodes-scheduler-taints-tolerations-removing.adoc[leveloffset=+1]
