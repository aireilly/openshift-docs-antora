...
// Uninstalling the {secondary-scheduler-operator}
include::ROOT:partial$nodes-secondary-scheduler-uninstall-console.adoc[leveloffset=+1]

// Removing {secondary-scheduler-operator} resources
include::ROOT:partial$nodes-secondary-scheduler-remove-resources-console.adoc[leveloffset=+1]
