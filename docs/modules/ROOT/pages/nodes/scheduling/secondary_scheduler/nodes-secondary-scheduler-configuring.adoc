...
include::ROOT:partial$nodes-secondary-scheduler-install-console.adoc[leveloffset=+1]

// Deploying a secondary scheduler
include::ROOT:partial$nodes-secondary-scheduler-configuring-console.adoc[leveloffset=+1]

// Scheduling a pod using the secondary scheduler
include::ROOT:partial$nodes-secondary-scheduler-pod-console.adoc[leveloffset=+1]
