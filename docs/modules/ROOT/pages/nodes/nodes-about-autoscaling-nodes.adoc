...
[discrete]
include::ROOT:partial$ocm-enabling-autoscaling-nodes.adoc[leveloffset=+2]
...
[discrete]
include::ROOT:partial$rosa-enabling-autoscaling-nodes.adoc[leveloffset=+2]
endif::[]
...
[discrete]
include::ROOT:partial$ocm-disabling-autoscaling-nodes.adoc[leveloffset=+2]

ifdef::openshift-rosa[]

[discrete]
include::ROOT:partial$rosa-disabling-autoscaling-nodes.adoc[leveloffset=+2]
endif::[]
