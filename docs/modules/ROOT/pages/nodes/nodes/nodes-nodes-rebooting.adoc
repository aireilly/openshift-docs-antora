...
include::ROOT:partial$nodes-nodes-rebooting-infrastructure.adoc[leveloffset=+1]
...
include::ROOT:partial$nodes-nodes-rebooting-affinity.adoc[leveloffset=+1]

include::ROOT:partial$nodes-nodes-rebooting-router.adoc[leveloffset=+1]

include::ROOT:partial$nodes-nodes-rebooting-gracefully.adoc[leveloffset=+1]
