...
include::ROOT:partial$nodes-pods-configuring-restart.adoc[leveloffset=+1]

include::ROOT:partial$nodes-pods-configuring-bandwidth.adoc[leveloffset=+1]

include::ROOT:partial$nodes-pods-pod-disruption-about.adoc[leveloffset=+1]

include::ROOT:partial$nodes-pods-pod-disruption-configuring.adoc[leveloffset=+2]

include::ROOT:partial$nodes-pods-configuring-pod-critical.adoc[leveloffset=+1]
