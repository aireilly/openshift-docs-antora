...
include::ROOT:partial$nodes-cluster-resource-levels-about.adoc[leveloffset=+1]

include::ROOT:partial$nodes-cluster-resource-levels-command.adoc[leveloffset=+1]

include::ROOT:partial$nodes-cluster-resource-levels-job.adoc[leveloffset=+1]
