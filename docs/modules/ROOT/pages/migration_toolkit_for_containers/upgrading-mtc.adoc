...
include::ROOT:partial$migration-upgrading-mtc-on-ocp-4.adoc[leveloffset=+1]
include::ROOT:partial$migration-upgrading-mtc-with-legacy-operator.adoc[leveloffset=+1]
include::ROOT:partial$migration-upgrading-from-mtc-1-3.adoc[leveloffset=+1]
:upgrading-mtc!:
