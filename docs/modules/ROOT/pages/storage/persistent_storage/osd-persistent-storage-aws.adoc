...
include::ROOT:partial$osd-storage-pv-aws-config-account.adoc[leveloffset=+1]
include::ROOT:partial$osd-storage-pv-aws-install-efs.adoc[leveloffset=+1]
include::ROOT:partial$osd-storage-pv-aws-create-sharedvolumes-console.adoc[leveloffset=+1]
include::ROOT:partial$osd-storage-pv-aws-create-sharedvolumes-cli.adoc[leveloffset=+1]
include::ROOT:partial$osd-storage-pv-aws-connect-pods.adoc[leveloffset=+1]
include::ROOT:partial$osd-storage-pv-aws-uninstall-efs.adoc[leveloffset=+1]
