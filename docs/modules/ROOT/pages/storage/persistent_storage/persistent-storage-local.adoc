...
include::ROOT:partial$persistent-storage-local-install.adoc[leveloffset=+1]

include::ROOT:partial$persistent-storage-local-create-cr.adoc[leveloffset=+1]

include::ROOT:partial$persistent-storage-local-create-cr-manual.adoc[leveloffset=+1]

include::ROOT:partial$persistent-storage-local-pvc.adoc[leveloffset=+1]

include::ROOT:partial$persistent-storage-local-pod.adoc[leveloffset=+1]

include::ROOT:partial$persistent-storage-local-discovery.adoc[leveloffset=+1]

include::ROOT:partial$persistent-storage-local-tolerations.adoc[leveloffset=+1]

include::ROOT:partial$persistent-storage-local-metrics.adoc[leveloffset=+1]
...
include::ROOT:partial$persistent-storage-local-removing-devices.adoc[leveloffset=+2]

include::ROOT:partial$persistent-storage-local-uninstall-operator.adoc[leveloffset=+2]
