...
include::ROOT:partial$storage-persistent-storage-creating-volume-claim.adoc[leveloffset=+1]

:provider: AWS
include::ROOT:partial$storage-persistent-storage-volume-format.adoc[leveloffset=+1]

include::ROOT:partial$storage-persistent-storage-aws-maximum-volumes.adoc[leveloffset=+1]

include::ROOT:partial$storage-persistent-storage-volume-encrypt-with-kms-key.adoc[leveloffset=+1]
