...
include::ROOT:partial$storage-azure-create-storage-class.adoc[leveloffset=+1]

include::ROOT:partial$storage-persistent-storage-creating-volume-claim.adoc[leveloffset=+1]

include::ROOT:partial$storage-persistent-storage-azure-volume-format.adoc[leveloffset=+1]
