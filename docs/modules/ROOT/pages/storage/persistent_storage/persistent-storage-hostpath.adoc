...
include::ROOT:partial$persistent-storage-hostpath-about.adoc[leveloffset=+1]
include::ROOT:partial$persistent-storage-hostpath-static-provisioning.adoc[leveloffset=+1]
include::ROOT:partial$persistent-storage-hostpath-pod.adoc[leveloffset=+1]
