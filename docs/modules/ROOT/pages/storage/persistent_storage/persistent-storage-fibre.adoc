...
include::ROOT:partial$persistent-storage-fibre-provisioning.adoc[leveloffset=+1]

include::ROOT:partial$persistent-storage-fibre-disk-quotas.adoc[leveloffset=+2]

include::ROOT:partial$persistent-storage-fibre-volume-security.adoc[leveloffset=+2]
