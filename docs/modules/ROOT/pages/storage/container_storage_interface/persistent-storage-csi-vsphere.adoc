...
include::ROOT:partial$persistent-storage-csi-vsphere-stor-policy.adoc[leveloffset=+1]

include::ROOT:partial$persistent-storage-csi-vsphere-rwx.adoc[leveloffset=+1]
...
include::ROOT:partial$persistent-storage-csi-vsphere-install-issues.adoc[leveloffset=+1]
