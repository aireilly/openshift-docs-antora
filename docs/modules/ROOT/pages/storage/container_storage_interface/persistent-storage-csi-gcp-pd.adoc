...
include::ROOT:partial$persistent-storage-csi-gcp-pd-storage-class-ref.adoc[leveloffset=+1]

include::ROOT:partial$persistent-storage-csi-gcp-pd-encrypted-pv.adoc[leveloffset=+1]
