...
include::ROOT:partial$osdk-helm-existing-chart.adoc[leveloffset=+2]
include::ROOT:partial$osdk-project-file.adoc[leveloffset=+2]

include::ROOT:partial$osdk-helm-logic.adoc[leveloffset=+1]
include::ROOT:partial$osdk-helm-sample-chart.adoc[leveloffset=+2]
include::ROOT:partial$osdk-helm-modify-cr.adoc[leveloffset=+2]
