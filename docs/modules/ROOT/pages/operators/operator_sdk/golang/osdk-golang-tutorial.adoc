...
include::ROOT:partial$osdk-common-prereqs.adoc[leveloffset=+1]

include::ROOT:partial$osdk-create-project.adoc[leveloffset=+1]
include::ROOT:partial$osdk-project-file.adoc[leveloffset=+2]
include::ROOT:partial$osdk-golang-manager.adoc[leveloffset=+2]
include::ROOT:partial$osdk-golang-multi-group-apis.adoc[leveloffset=+2]

include::ROOT:partial$osdk-golang-create-api-controller.adoc[leveloffset=+1]
include::ROOT:partial$osdk-golang-define-api.adoc[leveloffset=+2]
include::ROOT:partial$osdk-golang-generate-crd.adoc[leveloffset=+2]
include::ROOT:partial$osdk-about-openapi-validation.adoc[leveloffset=+3]

include::ROOT:partial$osdk-golang-implement-controller.adoc[leveloffset=+1]
...
include::ROOT:partial$osdk-golang-controller-resources.adoc[leveloffset=+2]
include::ROOT:partial$osdk-golang-controller-configs.adoc[leveloffset=+2]
include::ROOT:partial$osdk-golang-controller-reconcile-loop.adoc[leveloffset=+2]
include::ROOT:partial$osdk-golang-controller-rbac-markers.adoc[leveloffset=+2]

include::ROOT:partial$osdk-run-proxy.adoc[leveloffset=+1]
include::ROOT:partial$osdk-run-operator.adoc[leveloffset=+1]
include::ROOT:partial$osdk-run-locally.adoc[leveloffset=+2]
include::ROOT:partial$osdk-run-deployment.adoc[leveloffset=+2]

[id="osdk-bundle-deploy-olm_{context}"]
=== Bundling an Operator and deploying with Operator Lifecycle Manager

include::ROOT:partial$osdk-bundle-operator.adoc[leveloffset=+3]
include::ROOT:partial$osdk-deploy-olm.adoc[leveloffset=+3]

include::ROOT:partial$osdk-create-cr.adoc[leveloffset=+1]
