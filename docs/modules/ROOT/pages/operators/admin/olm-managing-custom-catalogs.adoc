...
include::ROOT:partial$olm-creating-fb-catalog-image.adoc[leveloffset=+2]
...
include::ROOT:partial$olm-creating-index-image.adoc[leveloffset=+2]
include::ROOT:partial$olm-updating-index-image.adoc[leveloffset=+2]
include::ROOT:partial$olm-pruning-index-image.adoc[leveloffset=+2]

include::ROOT:partial$olm-creating-catalog-from-index.adoc[leveloffset=+1]
...
include::ROOT:partial$olm-accessing-images-private-registries.adoc[leveloffset=+1]
...
include::ROOT:partial$olm-removing-catalogs.adoc[leveloffset=+1]
