...
include::ROOT:partial$olm-installing-from-operatorhub-using-web-console.adoc[leveloffset=+1]
ifdef::openshift-enterprise,openshift-webscale,openshift-origin[]
include::ROOT:partial$olm-installing-from-operatorhub-using-cli.adoc[leveloffset=+1]
...
include::ROOT:partial$olm-installing-specific-version-cli.adoc[leveloffset=+1]
...
include::ROOT:partial$olm-pod-placement.adoc[leveloffset=+1]
