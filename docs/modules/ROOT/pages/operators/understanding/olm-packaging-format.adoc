...
include::ROOT:partial$olm-bundle-format.adoc[leveloffset=+1]
include::ROOT:partial$olm-dependencies.adoc[leveloffset=+2]
...
include::ROOT:partial$olm-about-opm.adoc[leveloffset=+2]
...
include::ROOT:partial$olm-fb-catalogs.adoc[leveloffset=+1]
include::ROOT:partial$olm-fb-catalogs-structure.adoc[leveloffset=+2]
include::ROOT:partial$olm-fb-catalogs-schemas.adoc[leveloffset=+2]
include::ROOT:partial$olm-fb-catalogs-prop.adoc[leveloffset=+2]
include::ROOT:partial$olm-fb-catalogs-example.adoc[leveloffset=+2]
include::ROOT:partial$olm-fb-catalogs-guidelines.adoc[leveloffset=+2]
...
include::ROOT:partial$olm-fb-catalogs-automation.adoc[leveloffset=+2]
