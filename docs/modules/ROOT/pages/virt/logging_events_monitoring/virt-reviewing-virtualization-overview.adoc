...
include::ROOT:partial$virt-resources-monitored-actively-in-Virtualization-Overview-page.adoc[leveloffset=+1]

include::ROOT:partial$virt-resources-monitored-for-top-consumption.adoc[leveloffset=+1]

include::ROOT:partial$virt-reviewing-top-consumers-projects-vms-nodes.adoc[leveloffset=+1]
