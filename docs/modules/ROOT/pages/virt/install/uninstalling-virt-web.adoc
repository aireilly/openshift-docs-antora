...
include::ROOT:partial$virt-deleting-deployment-custom-resource.adoc[leveloffset=+1]

include::ROOT:partial$virt-deleting-catalog-subscription.adoc[leveloffset=+1]
...
include::ROOT:partial$deleting-a-namespace-using-the-web-console.adoc[leveloffset=+1]
