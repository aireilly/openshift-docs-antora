...
include::ROOT:partial$virt-about-upgrading-virt.adoc[leveloffset=+1]

[id="configuring-workload-updates_upgrading-virt"]
== Configuring automatic workload updates

include::ROOT:partial$virt-about-workload-updates.adoc[leveloffset=+2]

include::ROOT:partial$virt-configuring-workload-update-methods.adoc[leveloffset=+2]

[id="approving-operator-upgrades_upgrading-virt"]
== Approving pending Operator updates

include::ROOT:partial$olm-approving-pending-upgrade.adoc[leveloffset=+2]

[id="monitoring-upgrade-status_upgrading-virt"]
== Monitoring update status

include::ROOT:partial$virt-monitoring-upgrade-status.adoc[leveloffset=+2]

include::ROOT:partial$virt-viewing-outdated-workloads.adoc[leveloffset=+2]
