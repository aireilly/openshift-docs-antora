...
include::ROOT:partial$virt-openshift-client-commands.adoc[leveloffset=+1]
...
include::ROOT:partial$virt-virtctl-commands.adoc[leveloffset=+1]
include::ROOT:partial$virt-creating-pvc-with-virtctl-guestfs.adoc[leveloffset=+1]
include::ROOT:partial$virt-about-libguestfs-tools-virtctl-guestfs.adoc[leveloffset=+1]
