...
include::ROOT:partial$virt-hot-plugging-a-virtual-disk-using-the-cli.adoc[leveloffset=+1]
include::ROOT:partial$virt-hot-unplugging-a-virtual-disk-using-the-cli.adoc[leveloffset=+1]
include::ROOT:partial$virt-hot-plugging-a-virtual-disk-using-the-web-console.adoc[leveloffset=+1]
include::ROOT:partial$virt-hot-unplugging-a-virtual-disk-using-the-web-console.adoc[leveloffset=+1]
