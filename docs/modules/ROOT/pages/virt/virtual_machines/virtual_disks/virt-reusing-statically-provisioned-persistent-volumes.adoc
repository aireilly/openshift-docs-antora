...
include::ROOT:partial$virt-about-reclaiming-statically-provisioned-persistent-volumes.adoc[leveloffset=+1]
include::ROOT:partial$virt-reclaiming-statically-provisioned-persistent-volumes.adoc[leveloffset=+1]
