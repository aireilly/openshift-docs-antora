...
include::ROOT:partial$virt-creating-blank-disk-datavolumes.adoc[leveloffset=+1]

include::ROOT:partial$virt-template-blank-disk-datavolume.adoc[leveloffset=+1]
