...
include::ROOT:partial$virt-add-boot-order-web.adoc[leveloffset=+1]
include::ROOT:partial$virt-edit-boot-order-web.adoc[leveloffset=+1]
include::ROOT:partial$virt-edit-boot-order-yaml-web.adoc[leveloffset=+1]
include::ROOT:partial$virt-remove-boot-order-item-web.adoc[leveloffset=+1]
