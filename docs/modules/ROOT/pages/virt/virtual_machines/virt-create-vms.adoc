...
include::ROOT:partial$virt-creating-vm-quick-start-web.adoc[leveloffset=+1]

include::ROOT:partial$virt-creating-vm-wizard-web.adoc[leveloffset=+1]

Refer to the virtual machine wizard fields section when running the web console wizard.

:virtualmachine:
include::ROOT:partial$virt-vm-wizard-fields-web.adoc[leveloffset=+2]
...
include::ROOT:partial$virt-cloud-init-fields-web.adoc[leveloffset=+2]
...
include::ROOT:partial$virt-creating-vm-yaml-web.adoc[leveloffset=+2]

include::ROOT:partial$virt-creating-vm-cli.adoc[leveloffset=+1]

:virtualmachine!:

include::ROOT:partial$virt-vm-storage-volume-types.adoc[leveloffset=+1]

include::ROOT:partial$virt-about-runstrategies-vms.adoc[leveloffset=+1]
