...
include::ROOT:partial$virt-using-windows-dvd-disk-image.adoc[leveloffset=+1]

include::ROOT:partial$virt-using-disk-image-install-windows.adoc[leveloffset=+1]

include::ROOT:partial$virt-generalizing-windows-sysprep.adoc[leveloffset=+1]

include::ROOT:partial$virt-specializing-windows-sysprep.adoc[leveloffset=+1]
