...
include::ROOT:partial$virt-adding-secret-configmap-service-account-to-vm.adoc[leveloffset=+1]

include::ROOT:partial$virt-removing-secret-configmap-service-account-vm.adoc[leveloffset=+1]
