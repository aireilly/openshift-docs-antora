...
include::ROOT:partial$virt-about-node-placement-vms.adoc[leveloffset=+1]
...
include::ROOT:partial$virt-example-vm-node-placement-node-selector.adoc[leveloffset=+2]
include::ROOT:partial$virt-example-vm-node-placement-pod-affinity.adoc[leveloffset=+2]
include::ROOT:partial$virt-example-vm-node-placement-node-affinity.adoc[leveloffset=+2]
include::ROOT:partial$virt-example-vm-node-placement-tolerations.adoc[leveloffset=+2]
