...
include::ROOT:partial$virt-configuring-guest-memory-overcommitment.adoc[leveloffset=+1]

include::ROOT:partial$virt-disabling-guest-memory-overhead-accounting.adoc[leveloffset=+1]