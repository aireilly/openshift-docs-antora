...
include::ROOT:partial$virt-enabling-bootsource-update.adoc[leveloffset=+1]

include::ROOT:partial$virt-disable-bootsource-update.adoc[leveloffset=+1]

include::ROOT:partial$virt-reenabling-bootsource-update.adoc[leveloffset=+1]

include::ROOT:partial$virt-autoupdate-custom-bootsource.adoc[leveloffset=+1]
