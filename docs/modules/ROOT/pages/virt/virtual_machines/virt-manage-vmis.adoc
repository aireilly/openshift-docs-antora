...
include::ROOT:partial$virt-about-vmis.adoc[leveloffset=+1]

include::ROOT:partial$virt-listing-vmis-cli.adoc[leveloffset=+1]

include::ROOT:partial$virt-listing-vmis-web.adoc[leveloffset=+1]

include::ROOT:partial$virt-editing-vmis-web.adoc[leveloffset=+1]

include::ROOT:partial$virt-deleting-vmis-cli.adoc[leveloffset=+1]

include::ROOT:partial$virt-deleting-vmis-web.adoc[leveloffset=+1]
