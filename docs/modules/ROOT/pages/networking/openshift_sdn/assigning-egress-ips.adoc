...
include::ROOT:partial$nw-egress-ips-about.adoc[leveloffset=+1]

include::ROOT:partial$nw-egress-ips-automatic.adoc[leveloffset=+1]

include::ROOT:partial$nw-egress-ips-static.adoc[leveloffset=+1]
