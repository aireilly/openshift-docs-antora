...
include::ROOT:partial$nw-ne-openshift-dns.adoc[leveloffset=+1]
include::ROOT:partial$nw-ne-openshift-ingress.adoc[leveloffset=+1]
include::ROOT:partial$nw-ne-comparing-ingress-route.adoc[leveloffset=+2]
include::ROOT:partial$nw-networking-glossary-terms.adoc[leveloffset=+1]
