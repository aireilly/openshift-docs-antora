...
include::ROOT:partial$nw-ingress-creating-a-reencrypt-route-with-a-custom-certificate.adoc[leveloffset=+1]

include::ROOT:partial$nw-ingress-creating-an-edge-route-with-a-custom-certificate.adoc[leveloffset=+1]

include::ROOT:partial$nw-ingress-creating-a-passthrough-route.adoc[leveloffset=+1]
