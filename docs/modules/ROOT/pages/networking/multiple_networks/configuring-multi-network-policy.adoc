...
include::ROOT:partial$nw-multi-network-policy-differences.adoc[leveloffset=+1]
include::ROOT:partial$nw-multi-network-policy-enable.adoc[leveloffset=+1]
...
include::ROOT:partial$nw-networkpolicy-edit.adoc[leveloffset=+2]
include::ROOT:partial$nw-networkpolicy-view.adoc[leveloffset=+2]
include::ROOT:partial$nw-networkpolicy-delete.adoc[leveloffset=+2]
