...
include::ROOT:partial$nw-using-ingress-and-routes.adoc[leveloffset=+1]
...
include::ROOT:partial$nw-creating-project-and-service.adoc[leveloffset=+1]

include::ROOT:partial$nw-exposing-service.adoc[leveloffset=+1]

ifdef::openshift-enterprise,openshift-webscale,openshift-origin[]
include::ROOT:partial$nw-ingress-sharding-route-labels.adoc[leveloffset=+1]

include::ROOT:partial$nw-ingress-sharding-namespace-labels.adoc[leveloffset=+1]
