...
include::ROOT:partial$nw-sriov-hwol-about-hardware-offloading.adoc[leveloffset=+1]

//Which NICs do we support?

include::ROOT:partial$nw-sriov-hwol-supported-devices.adoc[leveloffset=+1]
...
include::ROOT:partial$nw-sriov-hwol-configuring-machine-config-pool.adoc[leveloffset=+1]

//Configuring the SR-IOV network node policy
include::ROOT:partial$nw-sriov-hwol-creating-sriov-policy.adoc[leveloffset=+1]

//Creating a Network Attachment Definition
include::ROOT:partial$nw-sriov-hwol-creating-network-attachment-definition.adoc[leveloffset=+1]

//Adding the network attachment definition to your pods
include::ROOT:partial$nw-sriov-hwol-adding-network-attachment-definitions-to-pods.adoc[leveloffset=+1]
