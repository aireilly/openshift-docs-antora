...
include::ROOT:partial$nw-pod-network-connectivity-checks.adoc[leveloffset=+1]
include::ROOT:partial$nw-pod-network-connectivity-implementation.adoc[leveloffset=+1]
include::ROOT:partial$nw-pod-network-connectivity-check-object.adoc[leveloffset=+1]
include::ROOT:partial$nw-pod-network-connectivity-verify.adoc[leveloffset=+1]
