...
include::ROOT:partial$metallb-installing-using-web-console.adoc[leveloffset=+1]

// Install the Operator with CLI
include::ROOT:partial$nw-metallb-installing-operator-cli.adoc[leveloffset=+1]

// Starting MetalLB on your cluster
include::ROOT:partial$nw-metallb-operator-initial-config.adoc[leveloffset=+1]

// Limit speaker pods to specific nodes
include::ROOT:partial$nw-metallb-operator-limit-speaker-to-nodes.adoc[leveloffset=+2]
