...
include::ROOT:partial$network-observability-flowcollector-view.adoc[leveloffset=+1]
include::ROOT:partial$network-observability-flowcollector-kafka-config.adoc[leveloffset=+1]
include::ROOT:partial$network-observability-configuring-FLP-sampling.adoc[leveloffset=+1]
include::ROOT:partial$network-observability-configuring-quickfilters-flowcollector.adoc[leveloffset=+1]