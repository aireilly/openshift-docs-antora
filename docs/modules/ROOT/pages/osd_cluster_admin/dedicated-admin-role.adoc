...
include::ROOT:partial$dedicated-logging-in-and-verifying-permissions.adoc[leveloffset=+1]

include::ROOT:partial$dedicated-managing-dedicated-administrators.adoc[leveloffset=+1]

include::ROOT:partial$dedicated-admin-granting-permissions.adoc[leveloffset=+1]

include::ROOT:partial$dedicated-managing-service-accounts.adoc[leveloffset=+1]

include::ROOT:partial$dedicated-managing-quotas-and-limit-ranges.adoc[leveloffset=+1]
