...
include::ROOT:partial$enable-private-cluster-new.adoc[leveloffset=+1]

include::ROOT:partial$enable-private-cluster-existing.adoc[leveloffset=+1]

include::ROOT:partial$enable-public-cluster.adoc[leveloffset=+1]
