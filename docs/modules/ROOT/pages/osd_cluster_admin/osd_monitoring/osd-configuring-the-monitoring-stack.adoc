...
include::ROOT:partial$osd-monitoring-maintenance-and-support.adoc[leveloffset=+1]
include::ROOT:partial$osd-monitoring-support-considerations.adoc[leveloffset=+2]

// Configuring the monitoring stack
include::ROOT:partial$osd-monitoring-configuring-the-monitoring-stack.adoc[leveloffset=+1]

// Configurable monitoring components
include::ROOT:partial$osd-monitoring-configurable-monitoring-components.adoc[leveloffset=+1]

// Moving monitoring components to different nodes
include::ROOT:partial$osd-monitoring-moving-monitoring-components-to-different-nodes.adoc[leveloffset=+1]
...
include::ROOT:partial$osd-monitoring-assigning-tolerations-to-monitoring-components.adoc[leveloffset=+1]
...
include::ROOT:partial$osd-monitoring-configuring-a-local-persistent-volume-claim.adoc[leveloffset=+2]
include::ROOT:partial$osd-monitoring-modifying-retention-time-for-prometheus-metrics-data.adoc[leveloffset=+2]
...
include::ROOT:partial$osd-monitoring-limiting-scrape-samples-in-user-defined-projects.adoc[leveloffset=+1]
include::ROOT:partial$osd-monitoring-setting-a-scrape-sample-limit-for-user-defined-projects.adoc[leveloffset=+2]
...
include::ROOT:partial$osd-monitoring-setting-log-levels-for-monitoring-components.adoc[leveloffset=+1]
