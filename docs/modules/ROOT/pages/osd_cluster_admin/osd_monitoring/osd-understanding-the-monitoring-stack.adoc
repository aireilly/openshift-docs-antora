...
// Understanding the monitoring stack
include::ROOT:partial$osd-monitoring-understanding-the-monitoring-stack.adoc[leveloffset=+1]
include::ROOT:partial$osd-monitoring-components-for-monitoring-user-defined-projects.adoc[leveloffset=+2]
include::ROOT:partial$osd-monitoring-targets-for-user-defined-projects.adoc[leveloffset=+2]
