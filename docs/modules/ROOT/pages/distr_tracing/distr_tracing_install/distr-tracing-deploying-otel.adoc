...
include::ROOT:partial$distr-tracing-config-otel-collector.adoc[leveloffset=+1]

[id="validating-your-otel-deployment"]
== Validating your deployment

include::ROOT:partial$distr-tracing-accessing-jaeger-console.adoc[leveloffset=+1]
