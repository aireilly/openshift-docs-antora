...
include::ROOT:partial$distr-tracing-deploy-default.adoc[leveloffset=+1]

include::ROOT:partial$distr-tracing-deploy-production-es.adoc[leveloffset=+1]

include::ROOT:partial$distr-tracing-deploy-streaming.adoc[leveloffset=+1]

[id="validating-your-jaeger-deployment"]
== Validating your deployment

include::ROOT:partial$distr-tracing-accessing-jaeger-console.adoc[leveloffset=+2]

[id="customizing-your-deployment"]
== Customizing your deployment

include::ROOT:partial$distr-tracing-deployment-best-practices.adoc[leveloffset=+2]
...
include::ROOT:partial$distr-tracing-config-default.adoc[leveloffset=+2]

include::ROOT:partial$distr-tracing-config-jaeger-collector.adoc[leveloffset=+2]

//include::ROOT:partial$distr-tracing-config-otel-collector.adoc[leveloffset=+2]

include::ROOT:partial$distr-tracing-config-sampling.adoc[leveloffset=+2]

include::ROOT:partial$distr-tracing-config-storage.adoc[leveloffset=+2]

include::ROOT:partial$distr-tracing-config-query.adoc[leveloffset=+2]

include::ROOT:partial$distr-tracing-config-ingester.adoc[leveloffset=+2]
...
include::ROOT:partial$distr-tracing-sidecar-automatic.adoc[leveloffset=+2]

include::ROOT:partial$distr-tracing-sidecar-manual.adoc[leveloffset=+2]
