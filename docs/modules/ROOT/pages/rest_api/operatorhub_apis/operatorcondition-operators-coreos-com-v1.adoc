...
| Parameter | Type | Description
| `body`
| xref:rest_api/operatorhub_apis/operatorcondition-operators-coreos-com-v1.adoc#operatorcondition-operators-coreos-com-v1[`OperatorCondition operators.coreos.com/v1`]
| 
|===
