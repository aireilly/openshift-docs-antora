...
include::ROOT:partial$dynamic-provisioning-about.adoc[leveloffset=+2]

include::ROOT:partial$dynamic-provisioning-available-plugins.adoc[leveloffset=+2]
...
include::ROOT:partial$ovirt-csi-driver-storage-class.adoc[leveloffset=+2]
...
include::ROOT:partial$available-persistent-storage-options.adoc[leveloffset=+1]

include::ROOT:partial$recommended-configurable-storage-technology.adoc[leveloffset=+1]
...
include::ROOT:partial$deploy-red-hat-openshift-container-storage.adoc[leveloffset=+1]
