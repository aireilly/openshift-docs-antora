...
include::ROOT:partial$images-update-global-pull-secret.adoc[leveloffset=+1]
...
include::ROOT:partial$machineset-delete-policy.adoc[leveloffset=+2]

include::ROOT:partial$nodes-scheduler-node-selectors-cluster.adoc[leveloffset=+2]
...
include::ROOT:partial$machineset-creating.adoc[leveloffset=+2]

include::ROOT:partial$creating-an-infra-node.adoc[leveloffset=+2]
...
include::ROOT:partial$creating-infra-machines.adoc[leveloffset=+2]
...
include::ROOT:partial$binding-infra-node-workloads-using-taints-tolerations.adoc[leveloffset=+2]
...
include::ROOT:partial$infrastructure-moving-router.adoc[leveloffset=+2]

include::ROOT:partial$infrastructure-moving-registry.adoc[leveloffset=+2]

include::ROOT:partial$infrastructure-moving-monitoring.adoc[leveloffset=+2]

include::ROOT:partial$infrastructure-moving-logging.adoc[leveloffset=+2]

include::ROOT:partial$cluster-autoscaler-about.adoc[leveloffset=+1]
include::ROOT:partial$cluster-autoscaler-cr.adoc[leveloffset=+2]
:FeatureName: cluster autoscaler
:FeatureResourceName: ClusterAutoscaler
include::ROOT:partial$deploying-resource.adoc[leveloffset=+2]

include::ROOT:partial$machine-autoscaler-about.adoc[leveloffset=+1]
include::ROOT:partial$machine-autoscaler-cr.adoc[leveloffset=+2]
...
include::ROOT:partial$nodes-cluster-enabling-features-about.adoc[leveloffset=+2]
include::ROOT:partial$nodes-cluster-enabling-features-console.adoc[leveloffset=+2]
include::ROOT:partial$nodes-cluster-enabling-features-cli.adoc[leveloffset=+2]

[id="post-install-etcd-tasks"]
== etcd tasks
Back up etcd, enable or disable etcd encryption, or defragment etcd data.

include::ROOT:partial$about-etcd-encryption.adoc[leveloffset=+2]
include::ROOT:partial$enabling-etcd-encryption.adoc[leveloffset=+2]
include::ROOT:partial$disabling-etcd-encryption.adoc[leveloffset=+2]
include::ROOT:partial$backup-etcd.adoc[leveloffset=+2]
include::ROOT:partial$etcd-defrag.adoc[leveloffset=+2]
include::ROOT:partial$dr-restoring-cluster-state.adoc[leveloffset=+2]
include::ROOT:partial$dr-scenario-cluster-state-issues.adoc[leveloffset=+2]
...
include::ROOT:partial$nodes-pods-pod-disruption-about.adoc[leveloffset=+2]
include::ROOT:partial$nodes-pods-pod-disruption-configuring.adoc[leveloffset=+2]
...
include::ROOT:partial$refreshing-service-ids-ibm-cloud.adoc[leveloffset=+3]

//Rotating cloud provider credentials manually
include::ROOT:partial$manually-rotating-cloud-creds.adoc[leveloffset=+2]
...
include::ROOT:partial$manually-removing-cloud-creds.adoc[leveloffset=+2]
...
include::ROOT:partial$installation-images-samples-disconnected-mirroring-assist.adoc[leveloffset=+2]

include::ROOT:partial$installation-restricted-network-samples.adoc[leveloffset=+2]

include::ROOT:partial$installation-preparing-restricted-cluster-to-gather-support-data.adoc[leveloffset=+2]

include::ROOT:partial$images-cluster-sample-imagestream-import.adoc[leveloffset=+1]