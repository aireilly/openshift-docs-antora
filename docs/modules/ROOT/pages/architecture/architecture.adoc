...
include::ROOT:partial$architecture-platform-introduction.adoc[leveloffset=+1]

include::ROOT:partial$architecture-kubernetes-introduction.adoc[leveloffset=+2]

include::ROOT:partial$architecture-container-application-benefits.adoc[leveloffset=+2]

include::ROOT:partial$architecture-platform-benefits.adoc[leveloffset=+2]
////
...
include::ROOT:partial$cluster-entitlements.adoc[leveloffset=+2]
