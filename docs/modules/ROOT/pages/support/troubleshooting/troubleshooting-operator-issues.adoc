...
include::ROOT:partial$querying-operator-pod-status.adoc[leveloffset=+1]

// Gathering Operator logs
include::ROOT:partial$gathering-operator-logs.adoc[leveloffset=+1]

// Disabling Machine Config Operator from autorebooting
include::ROOT:partial$troubleshooting-disabling-autoreboot-mco.adoc[leveloffset=+1]
include::ROOT:partial$troubleshooting-disabling-autoreboot-mco-console.adoc[leveloffset=+2]
include::ROOT:partial$troubleshooting-disabling-autoreboot-mco-cli.adoc[leveloffset=+2]
