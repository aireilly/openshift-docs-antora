...
include::ROOT:partial$investigating-kernel-crashes.adoc[leveloffset=+1]

include::ROOT:partial$troubleshooting-enabling-kdump.adoc[leveloffset=+2]

include::ROOT:partial$troubleshooting-enabling-kdump-day-one.adoc[leveloffset=+2]
...
include::ROOT:partial$troubleshooting-debugging-ignition.adoc[leveloffset=+1]
