...
include::ROOT:partial$strategies-for-s2i-troubleshooting.adoc[leveloffset=+1]

// Gathering Source-to-Image diagnostic data
include::ROOT:partial$gathering-s2i-diagnostic-data.adoc[leveloffset=+1]

// Gathering application diagnostic data to investigate application failures
include::ROOT:partial$gathering-application-diagnostic-data.adoc[leveloffset=+1]
