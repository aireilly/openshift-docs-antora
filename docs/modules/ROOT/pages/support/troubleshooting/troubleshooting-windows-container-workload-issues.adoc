...
include::ROOT:partial$wmco-does-not-install.adoc[leveloffset=+1]
...
include::ROOT:partial$investigating-why-windows-machine-compute-node.adoc[leveloffset=+1]
...
include::ROOT:partial$accessing-windows-node-using-ssh.adoc[leveloffset=+2]
include::ROOT:partial$accessing-windows-node-using-rdp.adoc[leveloffset=+2]

include::ROOT:partial$collecting-kube-node-logs-windows.adoc[leveloffset=+1]
include::ROOT:partial$collecting-windows-application-event-logs.adoc[leveloffset=+1]
include::ROOT:partial$collecting-docker-logs-windows.adoc[leveloffset=+1]
