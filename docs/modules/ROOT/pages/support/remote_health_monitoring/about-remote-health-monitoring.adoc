...
include::ROOT:partial$telemetry-about-telemetry.adoc[leveloffset=+1]
...
include::ROOT:partial$telemetry-what-information-is-collected.adoc[leveloffset=+2]
...
include::ROOT:partial$insights-operator-about.adoc[leveloffset=+1]
...
include::ROOT:partial$insights-operator-what-information-is-collected.adoc[leveloffset=+2]
...
include::ROOT:partial$understanding-telemetry-and-insights-operator-data-flow.adoc[leveloffset=+1]
