...
include::ROOT:partial$insights-operator-one-time-gather.adoc[leveloffset=+1]

include::ROOT:partial$insights-operator-manual-upload.adoc[leveloffset=+1]

include::ROOT:partial$insights-operator-enable-obfuscation.adoc[leveloffset=+1]
