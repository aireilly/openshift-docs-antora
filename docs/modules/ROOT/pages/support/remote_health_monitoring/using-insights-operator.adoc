...
include::ROOT:partial$insights-operator-downloading-archive.adoc[leveloffset=+1]
include::ROOT:partial$insights-operator-gather-duration.adoc[leveloffset=+1]
