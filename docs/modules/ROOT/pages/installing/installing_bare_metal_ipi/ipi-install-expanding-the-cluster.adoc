...
include::ROOT:partial$ipi-install-preparing-the-bare-metal-node.adoc[leveloffset=+1]
...
include::ROOT:partial$ipi-install-replacing-a-bare-metal-control-plane-node.adoc[leveloffset=+1]
...
include::ROOT:partial$ipi-install-preparing-to-deploy-with-virtual-media-on-the-baremetal-network.adoc[leveloffset=+1]

include::ROOT:partial$ipi-install-diagnosing-duplicate-mac-address.adoc[leveloffset=+1]

include::ROOT:partial$ipi-install-provisioning-the-bare-metal-node.adoc[leveloffset=+1]
