...
include::ROOT:partial$ipi-install-node-requirements.adoc[leveloffset=+1]

include::ROOT:partial$virt-planning-bare-metal-cluster-for-ocp-virt.adoc[leveloffset=+1]
...
include::ROOT:partial$ipi-install-firmware-requirements-for-installing-with-virtual-media.adoc[leveloffset=+1]

include::ROOT:partial$ipi-install-network-requirements.adoc[leveloffset=+1]

include::ROOT:partial$ipi-install-configuring-nodes.adoc[leveloffset=+1]

include::ROOT:partial$ipi-install-out-of-band-management.adoc[leveloffset=+1]

include::ROOT:partial$ipi-install-required-data-for-installation.adoc[leveloffset=+1]

include::ROOT:partial$ipi-install-validation-checklist-for-nodes.adoc[leveloffset=+1]
