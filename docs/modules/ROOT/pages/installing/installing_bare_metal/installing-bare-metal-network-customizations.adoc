...
include::ROOT:partial$nw-network-config.adoc[leveloffset=+1]
include::ROOT:partial$nw-modifying-operator-install-config.adoc[leveloffset=+1]
include::ROOT:partial$nw-operator-cr.adoc[leveloffset=+1]

include::ROOT:partial$installation-generate-ignition-configs.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-registry-storage-block-recreate-rollout-bare-metal.adoc[leveloffset=+2]
