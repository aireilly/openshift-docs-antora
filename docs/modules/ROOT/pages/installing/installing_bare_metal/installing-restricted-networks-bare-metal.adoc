...
include::ROOT:partial$installation-configuration-parameters.adoc[leveloffset=+2]

include::ROOT:partial$installation-bare-metal-config-yaml.adoc[leveloffset=+2]
...
include::ROOT:partial$installation-special-config-chrony.adoc[leveloffset=+1]

include::ROOT:partial$creating-machines-bare-metal.adoc[leveloffset=+1]

include::ROOT:partial$installation-user-infra-machines-iso.adoc[leveloffset=+2]

include::ROOT:partial$installation-user-infra-machines-pxe.adoc[leveloffset=+2]

include::ROOT:partial$installation-user-infra-machines-advanced.adoc[leveloffset=+2]

include::ROOT:partial$installation-user-infra-machines-advanced-customizing-iso-or-pxe.adoc[leveloffset=+4]

:boot-media: ISO image
:boot: iso
include::ROOT:partial$installation-user-infra-machines-advanced-customizing-live.adoc[leveloffset=+4]

include::ROOT:partial$installation-user-infra-machines-advanced-customizing-live-ca-certs.adoc[leveloffset=+5]

include::ROOT:partial$installation-user-infra-machines-advanced-customizing-live-network-config.adoc[leveloffset=+5]
:boot-media!:
:boot!:
...
include::ROOT:partial$installation-user-infra-machines-static-network.adoc[leveloffset=+3]

include::ROOT:partial$rhcos-enabling-multipath.adoc[leveloffset=+2]

include::ROOT:partial$architecture-rhcos-updating-bootloader.adoc[leveloffset=+2]
...
include::ROOT:partial$registry-change-management-state.adoc[leveloffset=+3]

include::ROOT:partial$registry-configuring-storage-baremetal.adoc[leveloffset=+3]

include::ROOT:partial$installation-registry-storage-non-production.adoc[leveloffset=+3]

include::ROOT:partial$installation-registry-storage-block-recreate-rollout-bare-metal.adoc[leveloffset=+3]
