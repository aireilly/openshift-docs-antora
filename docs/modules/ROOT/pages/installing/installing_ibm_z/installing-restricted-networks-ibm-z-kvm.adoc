...
include::ROOT:partial$installation-requirements-user-infra-ibm-z-kvm.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-ibm-z-kvm-user-infra-installing-rhcos.adoc[leveloffset=+1]

include::ROOT:partial$installation-ibm-z-kvm-user-infra-machines-iso.adoc[leveloffset=+2]

include::ROOT:partial$installation-full-ibm-z-kvm-user-infra-machines-iso.adoc[leveloffset=+2]

include::ROOT:partial$installation-user-infra-machines-static-network.adoc[leveloffset=+2]
