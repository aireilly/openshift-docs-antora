...
include::ROOT:partial$installation-creating-image-restricted.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-osp-restricted-config-yaml.adoc[leveloffset=+2]
