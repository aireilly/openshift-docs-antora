...
include::ROOT:partial$installation-osp-setting-cloud-provider-options.adoc[leveloffset=+1]
include::ROOT:partial$installation-osp-cloud-provider-lb-fip.adoc[leveloffset=+2]
...
// include::ROOT:partial$installation-osp-setting-worker-affinity.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-launching-installer.adoc[leveloffset=+1]
