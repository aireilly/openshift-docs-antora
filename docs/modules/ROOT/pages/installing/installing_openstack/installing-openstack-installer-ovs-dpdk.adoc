...
include::ROOT:partial$networking-osp-enabling-metadata.adoc[leveloffset=+1]
include::ROOT:partial$networking-osp-enabling-vfio-noiommu.adoc[leveloffset=+1]
include::ROOT:partial$installation-osp-dpdk-binding-vfio-pci.adoc[leveloffset=+1]
include::ROOT:partial$installation-osp-dpdk-exposing-host-interface.adoc[leveloffset=+1]
