...
include::ROOT:partial$installation-azure-limits.adoc[leveloffset=+1]

include::ROOT:partial$installation-azure-network-config.adoc[leveloffset=+1]

include::ROOT:partial$installation-azure-increasing-limits.adoc[leveloffset=+1]

include::ROOT:partial$installation-azure-permissions.adoc[leveloffset=+1]

include::ROOT:partial$installation-azure-service-principal.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-azure-marketplace.adoc[leveloffset=+1]

include::ROOT:partial$installation-azure-regions.adoc[leveloffset=+1]
