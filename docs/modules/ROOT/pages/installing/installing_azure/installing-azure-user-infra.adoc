...
include::ROOT:partial$installation-azure-limits.adoc[leveloffset=+2]
include::ROOT:partial$installation-azure-network-config.adoc[leveloffset=+2]
...
include::ROOT:partial$installation-azure-increasing-limits.adoc[leveloffset=+2]

include::ROOT:partial$csr-management.adoc[leveloffset=+2]

include::ROOT:partial$installation-azure-permissions.adoc[leveloffset=+2]
include::ROOT:partial$installation-azure-service-principal.adoc[leveloffset=+2]
...
include::ROOT:partial$installation-azure-regions.adoc[leveloffset=+2]
...
include::ROOT:partial$installation-azure-tested-machine-types.adoc[leveloffset=+2]

include::ROOT:partial$installation-azure-marketplace-subscribe.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-user-infra-exporting-common-variables-arm-templates.adoc[leveloffset=+2]
include::ROOT:partial$installation-user-infra-generate-k8s-manifest-ignition.adoc[leveloffset=+2]

include::ROOT:partial$installation-azure-create-resource-group-and-identity.adoc[leveloffset=+1]

include::ROOT:partial$installation-azure-user-infra-uploading-rhcos.adoc[leveloffset=+1]

include::ROOT:partial$installation-azure-create-dns-zones.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-creating-azure-vnet.adoc[leveloffset=+1]
include::ROOT:partial$installation-arm-vnet.adoc[leveloffset=+2]

include::ROOT:partial$installation-azure-user-infra-deploying-rhcos.adoc[leveloffset=+1]
include::ROOT:partial$installation-arm-image-storage.adoc[leveloffset=+2]

include::ROOT:partial$installation-network-user-infra.adoc[leveloffset=+1]

include::ROOT:partial$installation-creating-azure-dns.adoc[leveloffset=+1]
include::ROOT:partial$installation-arm-dns.adoc[leveloffset=+2]

include::ROOT:partial$installation-creating-azure-bootstrap.adoc[leveloffset=+1]
include::ROOT:partial$installation-arm-bootstrap.adoc[leveloffset=+2]

include::ROOT:partial$installation-creating-azure-control-plane.adoc[leveloffset=+1]
include::ROOT:partial$installation-arm-control-plane.adoc[leveloffset=+2]

include::ROOT:partial$installation-azure-user-infra-wait-for-bootstrap.adoc[leveloffset=+1]

include::ROOT:partial$installation-creating-azure-worker.adoc[leveloffset=+1]
include::ROOT:partial$installation-arm-worker.adoc[leveloffset=+2]
...
include::ROOT:partial$installation-azure-create-ingress-dns-records.adoc[leveloffset=+1]

include::ROOT:partial$installation-azure-user-infra-completing.adoc[leveloffset=+1]
