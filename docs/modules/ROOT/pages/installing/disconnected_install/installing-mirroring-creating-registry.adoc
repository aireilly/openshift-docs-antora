...
include::ROOT:partial$mirror-registry-introduction.adoc[leveloffset=+1]
include::ROOT:partial$mirror-registry-localhost.adoc[leveloffset=+1]
include::ROOT:partial$mirror-registry-localhost-update.adoc[leveloffset=+1]
include::ROOT:partial$mirror-registry-remote.adoc[leveloffset=+1]
include::ROOT:partial$mirror-registry-remote-host-update.adoc[leveloffset=+1]
include::ROOT:partial$mirror-registry-uninstall.adoc[leveloffset=+1]
include::ROOT:partial$mirror-registry-flags.adoc[leveloffset=+1]
include::ROOT:partial$mirror-registry-release-notes.adoc[leveloffset=+1]
