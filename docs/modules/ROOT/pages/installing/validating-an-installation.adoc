...
include::ROOT:partial$reviewing-the-installation-log.adoc[leveloffset=+1]

//Viewing the image pull source
include::ROOT:partial$viewing-the-image-pull-source.adoc[leveloffset=+1]

//Getting cluster version, status, and update details
include::ROOT:partial$getting-cluster-version-status-and-update-details.adoc[leveloffset=+1]
...
include::ROOT:partial$querying-the-status-of-cluster-nodes-using-the-cli.adoc[leveloffset=+1]
...
include::ROOT:partial$reviewing-cluster-status-from-the-openshift-web-console.adoc[leveloffset=+1]

//Reviewing the cluster status from {cluster-manager}
include::ROOT:partial$reviewing-cluster-status-from-the-openshift-cluster-manager.adoc[leveloffset=+1]
...
include::ROOT:partial$checking-cluster-resource-availability-and-utilization.adoc[leveloffset=+1]
...
include::ROOT:partial$listing-alerts-that-are-firing.adoc[leveloffset=+1]
