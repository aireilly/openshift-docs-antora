...
include::ROOT:partial$ipi-verifying-nodes-after-installation.adoc[leveloffset=+2]
...
include::ROOT:partial$supported-platforms-for-openshift-clusters.adoc[leveloffset=+1]
