...
include::ROOT:partial$installation-aws-regions-with-no-ami.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-aws-upload-custom-rhcos-ami.adoc[leveloffset=+1]
