...
include::ROOT:partial$private-clusters-about-gcp.adoc[leveloffset=+2]

include::ROOT:partial$installation-about-custom-gcp-vpc.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-gcp-config-yaml.adoc[leveloffset=+2]

include::ROOT:partial$nw-gcp-installing-global-access-configuration.adoc[leveloffset=+2]
