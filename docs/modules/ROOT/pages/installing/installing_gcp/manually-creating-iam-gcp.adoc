...
include::ROOT:partial$alternatives-to-storing-admin-secrets-in-kube-system.adoc[leveloffset=+1]
...
include::ROOT:partial$mint-mode.adoc[leveloffset=+1]

include::ROOT:partial$mint-mode-with-removal-of-admin-credential.adoc[leveloffset=+1]
