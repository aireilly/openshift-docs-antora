...
include::ROOT:partial$install-sno-about-installing-on-a-single-node.adoc[leveloffset=+1]

include::ROOT:partial$install-sno-requirements-for-installing-on-a-single-node.adoc[leveloffset=+1]
