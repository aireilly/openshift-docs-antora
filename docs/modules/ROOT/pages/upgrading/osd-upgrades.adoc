...
include::ROOT:partial$upgrade.adoc[leveloffset=+1]
...
include::ROOT:partial$upgrade-auto.adoc[leveloffset=+1]
include::ROOT:partial$upgrade-manual.adoc[leveloffset=+1]
