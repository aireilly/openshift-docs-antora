...
include::ROOT:partial$dedicated-enable-private-cluster-new.adoc[leveloffset=+1]

include::ROOT:partial$dedicated-enable-private-cluster-existing.adoc[leveloffset=+1]

include::ROOT:partial$dedicated-enable-public-cluster.adoc[leveloffset=+1]
