...
include::ROOT:partial$creating-a-machine-pool.adoc[leveloffset=+1]
include::ROOT:partial$creating-a-machine-pool-ocm.adoc[leveloffset=+2]
include::ROOT:partial$creating-a-machine-pool-cli.adoc[leveloffset=+2]
...
include::ROOT:partial$rosa-scaling-worker-nodes.adoc[leveloffset=+1]
include::ROOT:partial$rosa-adding-node-labels.adoc[leveloffset=+1]
include::ROOT:partial$rosa-adding-taints.adoc[leveloffset=+1]
