...
include::ROOT:partial$update-vsphere-virtual-hardware-on-control-plane-nodes.adoc[leveloffset=+2]
include::ROOT:partial$update-vsphere-virtual-hardware-on-compute-nodes.adoc[leveloffset=+2]
include::ROOT:partial$update-vsphere-virtual-hardware-on-template.adoc[leveloffset=+2]
...
include::ROOT:partial$scheduling-virtual-hardware-update-on-vsphere.adoc[leveloffset=+1]
