...
include::ROOT:partial$installation-adding-registry-pull-secret.adoc[leveloffset=+2]

include::ROOT:partial$update-mirror-repository.adoc[leveloffset=+1]

include::ROOT:partial$machine-health-checks-pausing.adoc[leveloffset=+1]

include::ROOT:partial$update-restricted.adoc[leveloffset=+1]

include::ROOT:partial$images-configuration-registry-mirror.adoc[leveloffset=+1]

include::ROOT:partial$generating-icsp-object-scoped-to-a-registry.adoc[leveloffset=+1]
