...
include::ROOT:partial$op-constructing-pipelines-using-pipeline-builder.adoc[leveloffset=+1]
...
include::ROOT:partial$op-interacting-with-pipelines-using-the-developer-perspective.adoc[leveloffset=+1]

include::ROOT:partial$op-using-custom-pipeline-template-for-git-import.adoc[leveloffset=+1]

include::ROOT:partial$op-starting-pipelines-from-pipelines-view.adoc[leveloffset=+1]

include::ROOT:partial$op-starting-pipelines-from-topology-view.adoc[leveloffset=+1]

include::ROOT:partial$op-interacting-pipelines-from-topology-view.adoc[leveloffset=+1]

include::ROOT:partial$op-editing-pipelines.adoc[leveloffset=+1]

include::ROOT:partial$op-deleting-pipelines.adoc[leveloffset=+1]
