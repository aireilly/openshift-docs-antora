...
include::ROOT:partial$op-installing-pipelines-as-code-on-an-openshift-cluster.adoc[leveloffset=+1]

include::ROOT:partial$op-installing-pipelines-as-code-cli.adoc[leveloffset=+1]

include::ROOT:partial$op-configuring-pipelines-as-code-for-a-git-repository-hosting-service-provider.adoc[leveloffset=+1]

include::ROOT:partial$op-configuring-pipelines-as-code-for-a-github-app.adoc[leveloffset=+2]

include::ROOT:partial$op-pipelines-as-code-command-reference.adoc[leveloffset=+1]

include::ROOT:partial$op-customizing-pipelines-as-code-configuration.adoc[leveloffset=+1]
