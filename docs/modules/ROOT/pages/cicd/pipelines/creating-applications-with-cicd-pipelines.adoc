...
include::ROOT:partial$op-creating-project-and-checking-pipeline-service-account.adoc[leveloffset=+1]

include::ROOT:partial$op-creating-pipeline-tasks.adoc[leveloffset=+1]
...
include::ROOT:partial$op-assembling-a-pipeline.adoc[leveloffset=+1]

include::ROOT:partial$op-mirroring-images-to-run-pipelines-in-restricted-environment.adoc[leveloffset=+1]
...
include::ROOT:partial$op-running-a-pipeline.adoc[leveloffset=+1]

include::ROOT:partial$op-adding-triggers.adoc[leveloffset=+1]

include::ROOT:partial$op-configuring-eventlisteners-to-serve-multiple-namespaces.adoc[leveloffset=+1]

include::ROOT:partial$op-creating-webhooks.adoc[leveloffset=+1]

include::ROOT:partial$op-triggering-a-pipelinerun.adoc[leveloffset=+1]

include::ROOT:partial$op-enabling-monitoring-of-event-listeners-for-triggers-for-user-defined-projects.adoc[leveloffset=+1]
