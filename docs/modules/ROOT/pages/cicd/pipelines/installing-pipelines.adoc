...
include::ROOT:partial$op-installing-pipelines-operator-in-web-console.adoc[leveloffset=+1]

// Installing pipelines Operator using CLI

include::ROOT:partial$op-installing-pipelines-operator-using-the-cli.adoc[leveloffset=+1]

// {pipelines-title} Operator in a restricted environment

include::ROOT:partial$op-pipelines-operator-in-restricted-environment.adoc[leveloffset=+1]

// Disabling automatic creation of RBAC resources 

include::ROOT:partial$op-disabling-automatic-creation-of-rbac-resources.adoc[leveloffset=+1]
