...
include::ROOT:partial$gitops-creating-a-new-client-using-keycloak.adoc[leveloffset=+1]

include::ROOT:partial$gitops-logging-into-keycloak.adoc[leveloffset=+1]

include::ROOT:partial$gitops-uninstall-keycloak.adoc[leveloffset=+1]
