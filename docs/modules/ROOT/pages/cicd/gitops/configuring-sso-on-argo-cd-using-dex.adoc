...
include::ROOT:partial$gitops-creating-a-new-client-in-dex.adoc[leveloffset=+1]

include::ROOT:partial$gitops-dex-role-mappings.adoc[leveloffset=+2]

//include::ROOT:partial$gitops-configuring-argo-cd-using-dex-github-conector.adoc[leveloffset=+1]

include::ROOT:partial$gitops-disable-dex.adoc[leveloffset=+1]

include::ROOT:partial$gitops-disable-dex-using-spec-sso.adoc[leveloffset=+1]
