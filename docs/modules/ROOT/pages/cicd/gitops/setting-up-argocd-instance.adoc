...
include::ROOT:partial$gitops-argo-cd-installation.adoc[leveloffset=+1]

include::ROOT:partial$gitops-enable-replicas-for-argo-cd-server.adoc[leveloffset=+1]

include::ROOT:partial$gitops-deploy-resources-different-namespaces.adoc[leveloffset=+1]
