...
include::ROOT:partial$builds-disabling-build-strategy-globally.adoc[leveloffset=+1]
include::ROOT:partial$builds-restricting-build-strategy-globally.adoc[leveloffset=+1]
include::ROOT:partial$builds-restricting-build-strategy-to-user.adoc[leveloffset=+1]
