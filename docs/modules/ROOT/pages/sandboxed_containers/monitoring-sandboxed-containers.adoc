...
include::ROOT:partial$sandboxed-containers-metrics-list.adoc[leveloffset=+1]
include::ROOT:partial$sandboxed-containers-query-metrics.adoc[leveloffset=+1]
...
include::ROOT:partial$sandboxed-containers-dashboard.adoc[leveloffset=+1]
