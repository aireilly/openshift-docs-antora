...
include::ROOT:partial$ossm-understanding-service-mesh.adoc[leveloffset=+1]

include::ROOT:partial$ossm-architecture.adoc[leveloffset=+1]
...
include::ROOT:partial$ossm-kiali-overview.adoc[leveloffset=+2]

include::ROOT:partial$ossm-kiali-architecture.adoc[leveloffset=+2]

include::ROOT:partial$ossm-kiali-features.adoc[leveloffset=+2]
...
include::ROOT:partial$distr-tracing-product-overview.adoc[leveloffset=+2]

include::ROOT:partial$distr-tracing-architecture.adoc[leveloffset=+2]

include::ROOT:partial$distr-tracing-features.adoc[leveloffset=+2]
