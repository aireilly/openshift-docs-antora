...
include::ROOT:partial$ossm-cr-example.adoc[leveloffset=+1]

== spec parameters

include::ROOT:partial$ossm-cr-general.adoc[leveloffset=+2]

include::ROOT:partial$ossm-cr-profiles.adoc[leveloffset=+2]
...
include::ROOT:partial$ossm-cr-techPreview.adoc[leveloffset=+2]

include::ROOT:partial$ossm-cr-tracing.adoc[leveloffset=+2]

include::ROOT:partial$ossm-cr-version.adoc[leveloffset=+2]

include::ROOT:partial$ossm-cr-threescale.adoc[leveloffset=+2]

include::ROOT:partial$ossm-cr-status.adoc[leveloffset=+1]
