...
include::ROOT:partial$distr-tracing-install-elasticsearch.adoc[leveloffset=+1]

include::ROOT:partial$distr-tracing-install-jaeger-operator.adoc[leveloffset=+1]

include::ROOT:partial$ossm-install-kiali.adoc[leveloffset=+1]

include::ROOT:partial$ossm-install-ossm-operator.adoc[leveloffset=+1]

include::ROOT:partial$ossm-control-plane-deploy-1x.adoc[leveloffset=+1]
...
include::ROOT:partial$ossm-member-roll-create.adoc[leveloffset=+1]

include::ROOT:partial$ossm-member-roll-modify.adoc[leveloffset=+1]
...
include::ROOT:partial$ossm-update-app-sidecar.adoc[leveloffset=+2]
