...
include::ROOT:partial$cluster-logging-collector-pod-location.adoc[leveloffset=+1]

include::ROOT:partial$cluster-logging-collector-limits.adoc[leveloffset=+1]

include::ROOT:partial$cluster-logging-collector-tuning.adoc[leveloffset=+1]

include::ROOT:partial$cluster-logging-removing-unused-components-if-no-elasticsearch.adoc[leveloffset=+1]
