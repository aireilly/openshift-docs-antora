...
include::ROOT:partial$cluster-logging-elasticsearch-tolerations.adoc[leveloffset=+1]

include::ROOT:partial$cluster-logging-kibana-tolerations.adoc[leveloffset=+1]

include::ROOT:partial$cluster-logging-collector-tolerations.adoc[leveloffset=+1]
