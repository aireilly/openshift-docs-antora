...
include::ROOT:partial$cluster-logging-dashboards-access.adoc[leveloffset=+1]
...
include::ROOT:partial$cluster-logging-dashboards-logging.adoc[leveloffset=+1]
include::ROOT:partial$cluster-logging-dashboards-es.adoc[leveloffset=+1]
