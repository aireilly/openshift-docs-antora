...
include::ROOT:partial$rosa-aws-requirements.adoc[leveloffset=+1]
include::ROOT:partial$rosa-aws-procedure.adoc[leveloffset=+1]
include::ROOT:partial$rosa-aws-scp.adoc[leveloffset=+1]
include::ROOT:partial$rosa-aws-iam.adoc[leveloffset=+1]
