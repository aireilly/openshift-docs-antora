...
include::ROOT:partial$rosa-sts-creating-a-cluster-quickly.adoc[leveloffset=+1]
include::ROOT:partial$rosa-sts-creating-a-cluster-quickly-ocm.adoc[leveloffset=+2]
include::ROOT:partial$rosa-sts-creating-a-cluster-quickly-cli.adoc[leveloffset=+2]
