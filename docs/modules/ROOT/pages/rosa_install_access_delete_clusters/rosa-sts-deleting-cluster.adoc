...
include::ROOT:partial$rosa-deleting-cluster.adoc[leveloffset=+1]
...
include::ROOT:partial$rosa-deleting-sts-iam-resources-account-wide.adoc[leveloffset=+1]
include::ROOT:partial$rosa-deleting-account-wide-iam-roles-and-policies.adoc[leveloffset=+2]
include::ROOT:partial$rosa-unlinking-and-deleting-ocm-and-user-iam-roles.adoc[leveloffset=+2]
