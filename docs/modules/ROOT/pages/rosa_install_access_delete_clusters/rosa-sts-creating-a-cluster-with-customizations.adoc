...
include::ROOT:partial$rosa-understanding-deployment-modes.adoc[leveloffset=+1]
include::ROOT:partial$rosa-creating-operator-roles-and-oidc-manually-ocm.adoc[leveloffset=+2]
include::ROOT:partial$rosa-sts-support-considerations.adoc[leveloffset=+1]
include::ROOT:partial$rosa-sts-creating-a-cluster-using-customizations.adoc[leveloffset=+1]
include::ROOT:partial$rosa-sts-creating-a-cluster-with-customizations-ocm.adoc[leveloffset=+2]
include::ROOT:partial$rosa-sts-creating-a-cluster-with-customizations-cli.adoc[leveloffset=+2]
