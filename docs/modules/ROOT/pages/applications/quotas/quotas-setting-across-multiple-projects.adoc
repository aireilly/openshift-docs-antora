...
include::ROOT:partial$quotas-selecting-projects.adoc[leveloffset=+1]
include::ROOT:partial$quotas-viewing-clusterresourcequotas.adoc[leveloffset=+1]
include::ROOT:partial$quotas-selection-granularity.adoc[leveloffset=+1]
