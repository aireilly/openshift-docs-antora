...
include::ROOT:partial$pruning-basic-operations.adoc[leveloffset=+1]
include::ROOT:partial$pruning-groups.adoc[leveloffset=+1]
include::ROOT:partial$pruning-deployments.adoc[leveloffset=+1]
include::ROOT:partial$pruning-builds.adoc[leveloffset=+1]
...
include::ROOT:partial$pruning-images.adoc[leveloffset=+1]
include::ROOT:partial$pruning-images-manual.adoc[leveloffset=+1]
...
include::ROOT:partial$pruning-hard-pruning-registry.adoc[leveloffset=+1]
include::ROOT:partial$pruning-cronjobs.adoc[leveloffset=+1]
