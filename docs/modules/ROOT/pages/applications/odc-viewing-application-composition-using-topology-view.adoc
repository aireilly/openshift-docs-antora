...
include::ROOT:partial$odc-viewing-application-topology.adoc[leveloffset=+1]

include::ROOT:partial$odc-interacting-with-applications-and-components.adoc[leveloffset=+1]

include::ROOT:partial$odc-scaling-application-pods-and-checking-builds-and-routes.adoc[leveloffset=+1]

include::ROOT:partial$odc-adding-components-to-an-existing-project.adoc[leveloffset=+1]

include::ROOT:partial$odc-grouping-multiple-components.adoc[leveloffset=+1]

include::ROOT:partial$odc-adding-services-to-application.adoc[leveloffset=+1]

include::ROOT:partial$odc-removing-services-from-application.adoc[leveloffset=+1]

include::ROOT:partial$odc-labels-and-annotations-used-for-topology-view.adoc[leveloffset=+1]
