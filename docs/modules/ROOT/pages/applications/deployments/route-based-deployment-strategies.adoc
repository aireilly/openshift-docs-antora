...
include::ROOT:partial$deployments-proxy-shards.adoc[leveloffset=+1]
include::ROOT:partial$deployments-n1-compatibility.adoc[leveloffset=+1]
include::ROOT:partial$deployments-graceful-termination.adoc[leveloffset=+1]
include::ROOT:partial$deployments-blue-green.adoc[leveloffset=+1]
include::ROOT:partial$deployments-ab-testing.adoc[leveloffset=+1]
include::ROOT:partial$deployments-ab-testing-lb.adoc[leveloffset=+2]
