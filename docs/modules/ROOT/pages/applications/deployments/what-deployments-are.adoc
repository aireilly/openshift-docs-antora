...
include::ROOT:partial$deployments-replicationcontrollers.adoc[leveloffset=+2]
include::ROOT:partial$deployments-replicasets.adoc[leveloffset=+2]

include::ROOT:partial$deployments-deploymentconfigs.adoc[leveloffset=+1]
include::ROOT:partial$deployments-kube-deployments.adoc[leveloffset=+1]
include::ROOT:partial$deployments-comparing-deploymentconfigs.adoc[leveloffset=+1]
////
Update when converted:
[role="_additional-resources"]
.Additional resources
