...
include::ROOT:partial$deployments-rolling-strategy.adoc[leveloffset=+1]
include::ROOT:partial$deployments-canary-deployments.adoc[leveloffset=+2]
include::ROOT:partial$deployments-creating-rolling-deployment.adoc[leveloffset=+2]
include::ROOT:partial$odc-starting-rolling-deployment.adoc[leveloffset=+2]
...
include::ROOT:partial$deployments-recreate-strategy.adoc[leveloffset=+1]
include::ROOT:partial$odc-starting-recreate-deployment.adoc[leveloffset=+1]
...
include::ROOT:partial$deployments-custom-strategy.adoc[leveloffset=+1]
include::ROOT:partial$deployments-lifecycle-hooks.adoc[leveloffset=+1]
