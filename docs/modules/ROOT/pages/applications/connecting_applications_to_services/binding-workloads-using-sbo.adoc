...
include::ROOT:partial$sbo-naming-strategies.adoc[leveloffset=+1]
include::ROOT:partial$sbo-advanced-binding-options.adoc[leveloffset=+1]
include::ROOT:partial$sbo-binding-workloads-that-are-not-compliant-with-PodSpec.adoc[leveloffset=+1]
include::ROOT:partial$sbo-unbinding-workloads-from-a-backing-service.adoc[leveloffset=+1]
