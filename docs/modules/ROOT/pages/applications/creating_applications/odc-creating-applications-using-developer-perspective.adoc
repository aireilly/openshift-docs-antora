...
include::ROOT:partial$odc-creating-sample-applications.adoc[leveloffset=+1]

include::ROOT:partial$odc-importing-codebase-from-git-to-create-application.adoc[leveloffset=+1]

include::ROOT:partial$odc-deploying-java-applications.adoc[leveloffset=+1]

include::ROOT:partial$odc-using-the-devfile-registry.adoc[leveloffset=+1]

include::ROOT:partial$odc-using-the-developer-catalog-to-add-services-or-components.adoc[leveloffset=+1]
