...
include::ROOT:partial$applications-create-using-cli-source-code.adoc[leveloffset=+1]

include::ROOT:partial$applications-create-using-cli-image.adoc[leveloffset=+1]

include::ROOT:partial$applications-create-using-cli-template.adoc[leveloffset=+1]

include::ROOT:partial$applications-create-using-cli-modify.adoc[leveloffset=+1]
