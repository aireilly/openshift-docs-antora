...
include::ROOT:partial$odc-editing-source-code-using-developer-perspective.adoc[leveloffset=+1]

include::ROOT:partial$odc-editing-application-configuration-using-developer-perspective.adoc[leveloffset=+1]
