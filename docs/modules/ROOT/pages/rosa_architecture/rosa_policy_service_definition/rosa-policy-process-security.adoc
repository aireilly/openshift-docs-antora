...
include::ROOT:partial$rosa-policy-incident.adoc[leveloffset=+1]
include::ROOT:partial$rosa-policy-change-management.adoc[leveloffset=+1]
include::ROOT:partial$rosa-policy-identity-access-management.adoc[leveloffset=+1]
include::ROOT:partial$rosa-policy-security-regulation-compliance.adoc[leveloffset=+1]
include::ROOT:partial$rosa-policy-disaster-recovery.adoc[leveloffset=+1]
