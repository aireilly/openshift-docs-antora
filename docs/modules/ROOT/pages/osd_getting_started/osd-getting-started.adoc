...
include::ROOT:partial$config-idp.adoc[leveloffset=+1]
...
include::ROOT:partial$osd-grant-admin-privileges.adoc[leveloffset=+1]
include::ROOT:partial$access-cluster.adoc[leveloffset=+1]
include::ROOT:partial$deploy-app.adoc[leveloffset=+1]
include::ROOT:partial$scaling-cluster.adoc[leveloffset=+1]
...
include::ROOT:partial$osd-revoke-admin-privileges.adoc[leveloffset=+1]
include::ROOT:partial$osd-revoke-user-access.adoc[leveloffset=+1]
include::ROOT:partial$deleting-cluster.adoc[leveloffset=+1]
