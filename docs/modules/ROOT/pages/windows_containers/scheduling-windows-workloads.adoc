...
include::ROOT:partial$windows-pod-placement.adoc[leveloffset=+1]
...
include::ROOT:partial$creating-runtimeclass.adoc[leveloffset=+1]

include::ROOT:partial$sample-windows-workload-deployment.adoc[leveloffset=+1]
