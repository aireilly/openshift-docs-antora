...
include::ROOT:partial$creating-the-vsphere-windows-vm-golden-image.adoc[leveloffset=+2]
...
include::ROOT:partial$enabling-internal-api-server-vsphere.adoc[leveloffset=+2]

include::ROOT:partial$windows-machineset-vsphere.adoc[leveloffset=+1]
