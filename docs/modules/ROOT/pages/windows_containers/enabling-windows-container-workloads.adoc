...
include::ROOT:partial$installing-wmco-using-web-console.adoc[leveloffset=+2]

include::ROOT:partial$installing-wmco-using-cli.adoc[leveloffset=+2]

include::ROOT:partial$configuring-secret-for-wmco.adoc[leveloffset=+1]
