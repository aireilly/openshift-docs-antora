...
include::ROOT:partial$psap-special-resource-operator.adoc[leveloffset=+1]
...
include::ROOT:partial$psap-special-resource-operator-installing-using-cli.adoc[leveloffset=+2]

include::ROOT:partial$psap-special-resource-operator-installing-using-web-console.adoc[leveloffset=+2]

include::ROOT:partial$psap-special-resource-operator-using.adoc[leveloffset=+1]

include::ROOT:partial$psap-special-resource-operator-using-configmaps.adoc[leveloffset=+2]


include::ROOT:partial$psap-special-resource-operator-metrics.adoc[leveloffset=+1]
