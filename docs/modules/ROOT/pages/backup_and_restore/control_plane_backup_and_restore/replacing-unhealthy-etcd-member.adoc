...
include::ROOT:partial$restore-identify-unhealthy-etcd-member.adoc[leveloffset=+1]

// Determining the state of the unhealthy etcd member
include::ROOT:partial$restore-determine-state-etcd-member.adoc[leveloffset=+1]
...
include::ROOT:partial$restore-replace-stopped-etcd-member.adoc[leveloffset=+2]

// Replacing an unhealthy etcd member whose etcd pod is crashlooping
include::ROOT:partial$restore-replace-crashlooping-etcd-member.adoc[leveloffset=+2]

// Replacing an unhealthy baremetal stopped etcd member
include::ROOT:partial$restore-replace-stopped-baremetal-etcd-member.adoc[leveloffset=+2]
