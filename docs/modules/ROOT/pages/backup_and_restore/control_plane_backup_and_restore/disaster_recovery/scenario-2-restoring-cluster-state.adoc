...
include::ROOT:partial$dr-restoring-cluster-state-about.adoc[leveloffset=+1]

// Restoring to a previous cluster state
include::ROOT:partial$dr-restoring-cluster-state.adoc[leveloffset=+1]
include::ROOT:partial$dr-scenario-cluster-state-issues.adoc[leveloffset=+1]
