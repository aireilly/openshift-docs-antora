...
include::ROOT:partial$oadp-creating-backup-cr.adoc[leveloffset=+1]
include::ROOT:partial$oadp-backing-up-pvs-csi.adoc[leveloffset=+1]
include::ROOT:partial$oadp-backing-up-applications-restic.adoc[leveloffset=+1]
include::ROOT:partial$oadp-using-data-mover-for-csi-snapshots.adoc[leveloffset=+1]
...
include::ROOT:partial$oadp-creating-backup-hooks.adoc[leveloffset=+1]
include::ROOT:partial$oadp-scheduling-backups.adoc[leveloffset=+1]
include::ROOT:partial$oadp-deleting-backups.adoc[leveloffset=+1]
