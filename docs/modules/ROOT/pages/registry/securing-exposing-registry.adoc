...
include::ROOT:partial$registry-exposing-default-registry-manually.adoc[leveloffset=+1]
include::ROOT:partial$registry-exposing-secure-registry-manually.adoc[leveloffset=+1]
