...
include::ROOT:partial$serverless-monitoring-services-default-metrics.adoc[leveloffset=+1]

include::ROOT:partial$serverless-monitoring-services-custom-metrics.adoc[leveloffset=+1]

include::ROOT:partial$serverless-monitoring-services-configuration-scraping.adoc[leveloffset=+1]

include::ROOT:partial$serverless-monitoring-services-examining-metrics.adoc[leveloffset=+1]

include::ROOT:partial$serverless-queue-proxy-metrics.adoc[leveloffset=+2]

include::ROOT:partial$serverless-monitoring-services-examining-metrics-dashboard.adoc[leveloffset=+1]
