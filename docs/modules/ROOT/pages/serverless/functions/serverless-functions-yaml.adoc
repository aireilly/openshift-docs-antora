...
include::ROOT:partial$serverless-functions-func-yaml-fields.adoc[leveloffset=+1]
include::ROOT:partial$serverless-functions-func-yaml-environment-variables.adoc[leveloffset=+1]
