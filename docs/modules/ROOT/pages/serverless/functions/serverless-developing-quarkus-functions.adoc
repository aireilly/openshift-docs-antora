...
// templates, invoking
include::ROOT:partial$serverless-quarkus-template.adoc[leveloffset=+1]
include::ROOT:partial$serverless-invoking-quarkus-functions.adoc[leveloffset=+1]
include::ROOT:partial$serverless-quarkus-cloudevent-attributes.adoc[leveloffset=+1]
// return values
include::ROOT:partial$serverless-quarkus-function-return-values.adoc[leveloffset=+1]
include::ROOT:partial$serverless-functions-quarkus-return-value-types.adoc[leveloffset=+2]
// testing
include::ROOT:partial$serverless-testing-quarkus-functions.adoc[leveloffset=+1]
