...
include::ROOT:partial$serverless-go-template.adoc[leveloffset=+1]
...
include::ROOT:partial$serverless-invoking-go-functions-http.adoc[leveloffset=+2]
include::ROOT:partial$serverless-invoking-go-functions-cloudevent.adoc[leveloffset=+2]

include::ROOT:partial$serverless-go-function-return-values.adoc[leveloffset=+1]
include::ROOT:partial$serverless-testing-go-functions.adoc[leveloffset=+1]
