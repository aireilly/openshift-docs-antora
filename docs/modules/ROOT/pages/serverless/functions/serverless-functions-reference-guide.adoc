...
include::ROOT:partial$serverless-nodejs-context-object-reference.adoc[leveloffset=+1]
include::ROOT:partial$serverless-typescript-context-object-reference.adoc[leveloffset=+1]
