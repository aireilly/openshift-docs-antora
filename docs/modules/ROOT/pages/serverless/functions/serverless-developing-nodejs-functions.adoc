...
include::ROOT:partial$serverless-nodejs-template.adoc[leveloffset=+1]
...
include::ROOT:partial$serverless-nodejs-functions-context-objects.adoc[leveloffset=+2]
include::ROOT:partial$serverless-nodejs-function-return-values.adoc[leveloffset=+1]
include::ROOT:partial$serverless-testing-nodejs-functions.adoc[leveloffset=+1]
