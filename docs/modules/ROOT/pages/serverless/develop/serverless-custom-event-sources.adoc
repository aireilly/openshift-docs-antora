...
// sinkbinding intro
include::ROOT:partial$serverless-sinkbinding-intro.adoc[leveloffset=+1]
// YAML
include::ROOT:partial$serverless-sinkbinding-yaml.adoc[leveloffset=+2]
// kn commands
include::ROOT:partial$serverless-sinkbinding-kn.adoc[leveloffset=+2]
include::ROOT:partial$specifying-sink-flag-kn.adoc[leveloffset=+3]
// ODC
include::ROOT:partial$serverless-sinkbinding-odc.adoc[leveloffset=+2]
// Reference
include::ROOT:partial$serverless-sinkbinding-reference.adoc[leveloffset=+2]
...
// intro
include::ROOT:partial$serverless-containersource-guidelines.adoc[leveloffset=+2]
// kn
include::ROOT:partial$serverless-kn-containersource.adoc[leveloffset=+2]
// ODC
include::ROOT:partial$serverless-odc-create-containersource.adoc[leveloffset=+2]
// Reference
include::ROOT:partial$serverless-containersource-reference.adoc[leveloffset=+2]
