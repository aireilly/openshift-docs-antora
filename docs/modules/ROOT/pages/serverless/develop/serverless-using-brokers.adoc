...
include::ROOT:partial$serverless-create-broker-kn.adoc[leveloffset=+1]
include::ROOT:partial$serverless-creating-broker-annotation.adoc[leveloffset=+1]
include::ROOT:partial$serverless-creating-broker-labeling.adoc[leveloffset=+1]
include::ROOT:partial$serverless-deleting-broker-injection.adoc[leveloffset=+1]
include::ROOT:partial$serverless-creating-a-broker-odc.adoc[leveloffset=+1]
...
include::ROOT:partial$serverless-kafka-broker.adoc[leveloffset=+2]
include::ROOT:partial$serverless-kafka-broker-with-kafka-topic.adoc[leveloffset=+2]
...
include::ROOT:partial$serverless-list-broker-kn.adoc[leveloffset=+2]
include::ROOT:partial$serverless-describe-broker-kn.adoc[leveloffset=+2]
