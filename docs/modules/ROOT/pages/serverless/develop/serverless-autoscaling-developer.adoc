...
// minscale docs
include::ROOT:partial$serverless-autoscaling-developer-minscale.adoc[leveloffset=+2]
include::ROOT:partial$serverless-autoscaling-minscale-kn.adoc[leveloffset=+3]

// maxscale docs
include::ROOT:partial$serverless-autoscaling-developer-maxscale.adoc[leveloffset=+2]
include::ROOT:partial$serverless-autoscaling-maxscale-kn.adoc[leveloffset=+3]

// concurrency
include::ROOT:partial$serverless-about-concurrency.adoc[leveloffset=+1]
include::ROOT:partial$serverless-concurrency-limits-configure-soft.adoc[leveloffset=+2]
include::ROOT:partial$serverless-concurrency-limits-configure-hard.adoc[leveloffset=+2]
include::ROOT:partial$serverless-target-utilization.adoc[leveloffset=+2]
