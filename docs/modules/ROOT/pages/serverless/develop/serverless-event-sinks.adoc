...
include::ROOT:partial$specifying-sink-flag-kn.adoc[leveloffset=+1]
...
include::ROOT:partial$serverless-connect-sink-source-odc.adoc[leveloffset=+1]
// Connect a trigger to a sink
include::ROOT:partial$serverless-connect-trigger-sink.adoc[leveloffset=+1]
