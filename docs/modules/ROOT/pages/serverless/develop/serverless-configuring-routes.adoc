...
include::ROOT:partial$serverless-customize-labels-annotations-routes.adoc[leveloffset=+1]
include::ROOT:partial$serverless-openshift-routes.adoc[leveloffset=+1]
include::ROOT:partial$knative-service-cluster-local.adoc[leveloffset=+1]
