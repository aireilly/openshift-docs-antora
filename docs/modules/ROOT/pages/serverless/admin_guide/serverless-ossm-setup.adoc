...
include::ROOT:partial$serverless-ossm-external-certs.adoc[leveloffset=+1]
// without kourier
include::ROOT:partial$serverless-ossm-setup.adoc[leveloffset=+1]
include::ROOT:partial$serverless-ossm-enabling-serving-metrics.adoc[leveloffset=+1]
// With kourier
include::ROOT:partial$serverless-ossm-setup-with-kourier.adoc[leveloffset=+1]
include::ROOT:partial$serverless-ossm-secret-filtering.adoc[leveloffset=+1]
