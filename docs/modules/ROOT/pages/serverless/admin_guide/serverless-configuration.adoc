...
// Knative Eventing
include::ROOT:partial$serverless-channel-default.adoc[leveloffset=+1]
include::ROOT:partial$serverless-broker-backing-channel-default.adoc[leveloffset=+1]
include::ROOT:partial$serverless-global-config-broker-class-default.adoc[leveloffset=+1]
...
// Knative Serving
//autoscaling
include::ROOT:partial$serverless-enable-scale-to-zero.adoc[leveloffset=+1]
include::ROOT:partial$serverless-scale-to-zero-grace-period.adoc[leveloffset=+1]
...
include::ROOT:partial$knative-serving-CR-system-deployments.adoc[leveloffset=+2]
...
include::ROOT:partial$knative-eventing-CR-system-deployments.adoc[leveloffset=+2]
...
// enable emptydirs
include::ROOT:partial$serverless-config-emptydir.adoc[leveloffset=+1]
// global https redirect
include::ROOT:partial$serverless-https-redirect-global.adoc[leveloffset=+1]
// URL scheme for external routes
include::ROOT:partial$serverless-url-scheme-external-routes.adoc[leveloffset=+1]
// Kourier Gateway service type
include::ROOT:partial$serverless-kourier-gateway-service-type.adoc[leveloffset=+1]
// Enabling PVC for Serving
include::ROOT:partial$serverless-enabling-pvc-support.adoc[leveloffset=+1]
// enable init containers
include::ROOT:partial$serverless-admin-init-containers.adoc[leveloffset=+1]
// Tag to digest resolution
include::ROOT:partial$serverless-tag-to-digest-resolution.adoc[leveloffset=+1]
include::ROOT:partial$knative-serving-controller-custom-certs-secrets.adoc[leveloffset=+2]
