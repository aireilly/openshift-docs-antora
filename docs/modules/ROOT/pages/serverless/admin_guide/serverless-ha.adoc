...
include::ROOT:partial$serverless-config-replicas-serving.adoc[leveloffset=+1]
include::ROOT:partial$serverless-config-replicas-eventing.adoc[leveloffset=+1]
include::ROOT:partial$serverless-config-replicas-kafka.adoc[leveloffset=+1]
