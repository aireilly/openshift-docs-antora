...
include::ROOT:partial$serverless-install-kafka-odc.adoc[leveloffset=+1]
...
include::ROOT:partial$serverless-kafka-broker-tls-default-config.adoc[leveloffset=+2]
include::ROOT:partial$serverless-kafka-broker-sasl-default-config.adoc[leveloffset=+2]

// kafka channel security config
include::ROOT:partial$serverless-kafka-tls-channels.adoc[leveloffset=+2]
include::ROOT:partial$serverless-kafka-sasl-channels.adoc[leveloffset=+2]
include::ROOT:partial$serverless-kafka-sasl-source.adoc[leveloffset=+2]

// kafka sink security config
include::ROOT:partial$serverless-kafka-sink-security-config.adoc[leveloffset=+2]

// kafka broker general configmap
include::ROOT:partial$serverless-kafka-broker-configmap.adoc[leveloffset=+1]
