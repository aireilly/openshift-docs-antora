...
// Multitenancy
include::ROOT:partial$security-platform-multi-tenancy.adoc[leveloffset=+1]

// Admission plugins
include::ROOT:partial$security-platform-admission.adoc[leveloffset=+1]

// Authentication and authorization
include::ROOT:partial$security-platform-authentication.adoc[leveloffset=+1]

// Managing certificates for the platform
include::ROOT:partial$security-platform-certificates.adoc[leveloffset=+1]
