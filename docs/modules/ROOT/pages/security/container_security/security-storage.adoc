...
include::ROOT:partial$security-storage-persistent.adoc[leveloffset=+1]

// Shared storage
include::ROOT:partial$security-storage-shared.adoc[leveloffset=+1]

// Block storage
include::ROOT:partial$security-storage-block.adoc[leveloffset=+1]
