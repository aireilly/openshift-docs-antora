...
include::ROOT:partial$security-build-once.adoc[leveloffset=+1]

// Build management and security
include::ROOT:partial$security-build-management.adoc[leveloffset=+1]

// Securing inputs during builds
include::ROOT:partial$security-build-inputs.adoc[leveloffset=+1]

// Designing your build process
include::ROOT:partial$security-build-designing.adoc[leveloffset=+1]

// Knative builds
include::ROOT:partial$security-build-knative.adoc[leveloffset=+1]
