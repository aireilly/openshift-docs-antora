...
// Network namespaces
include::ROOT:partial$security-network-namespaces.adoc[leveloffset=+1]

// Network policies
include::ROOT:partial$security-network-policies.adoc[leveloffset=+1]
...
include::ROOT:partial$security-network-multiple-pod.adoc[leveloffset=+1]
...
include::ROOT:partial$security-network-isolating.adoc[leveloffset=+1]
...
// Ingress traffic
include::ROOT:partial$security-network-ingress.adoc[leveloffset=+1]
...
// Egress traffic
include::ROOT:partial$security-network-egress.adoc[leveloffset=+1]
