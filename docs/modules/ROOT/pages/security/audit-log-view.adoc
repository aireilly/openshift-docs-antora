...
include::ROOT:partial$nodes-nodes-audit-log-basic.adoc[leveloffset=+1]

// Viewing the audit log
include::ROOT:partial$nodes-nodes-audit-log-basic-viewing.adoc[leveloffset=+1]

// Filtering audit logs
include::ROOT:partial$security-audit-log-filtering.adoc[leveloffset=+1]

// Gathering audit logs
include::ROOT:partial$gathering-data-audit-logs.adoc[leveloffset=+1]
