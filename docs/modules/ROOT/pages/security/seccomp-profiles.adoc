...
include::ROOT:partial$configuring-default-seccomp-profile.adoc[leveloffset=+1]
...
include::ROOT:partial$setting-custom-seccomp-profile.adoc[leveloffset=+2]
include::ROOT:partial$applying-custom-seccomp-profile.adoc[leveloffset=+2]
