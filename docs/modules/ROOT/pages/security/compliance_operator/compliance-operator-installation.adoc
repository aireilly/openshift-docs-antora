...
include::ROOT:partial$compliance-operator-console-installation.adoc[leveloffset=+1]
...
include::ROOT:partial$compliance-operator-cli-installation.adoc[leveloffset=+1]
