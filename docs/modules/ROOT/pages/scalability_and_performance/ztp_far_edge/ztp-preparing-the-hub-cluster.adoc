...
include::ROOT:partial$ztp-telco-ran-software-versions.adoc[leveloffset=+1]

include::ROOT:partial$ztp-acm-installing-disconnected-rhacm.adoc[leveloffset=+1]
...
include::ROOT:partial$ztp-acm-adding-images-to-mirror-registry.adoc[leveloffset=+1]
...
include::ROOT:partial$ztp-enabling-assisted-installer-service-on-bare-metal.adoc[leveloffset=+1]

include::ROOT:partial$ztp-configuring-the-cluster-for-a-disconnected-environment.adoc[leveloffset=+1]


include::ROOT:partial$ztp-preparing-the-hub-cluster-for-ztp.adoc[leveloffset=+1]
...
include::ROOT:partial$ztp-preparing-the-ztp-git-repository.adoc[leveloffset=+1]
