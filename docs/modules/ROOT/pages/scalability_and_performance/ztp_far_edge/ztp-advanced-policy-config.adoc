...
include::ROOT:partial$ztp-deploying-additional-changes-to-clusters.adoc[leveloffset=+1]
...
include::ROOT:partial$ztp-using-pgt-to-update-source-crs.adoc[leveloffset=+1]

include::ROOT:partial$ztp-adding-new-content-to-gitops-ztp.adoc[leveloffset=+1]
...
include::ROOT:partial$ztp-creating-a-validator-inform-policy.adoc[leveloffset=+1]
...
include::ROOT:partial$ztp-configuring-ptp-fast-events.adoc[leveloffset=+1]
...
include::ROOT:partial$ztp-configuring-hwevents-using-pgt.adoc[leveloffset=+1]
