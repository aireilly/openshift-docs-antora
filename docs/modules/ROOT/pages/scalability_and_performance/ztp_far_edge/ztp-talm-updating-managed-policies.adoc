...
include::ROOT:partial$cnf-topology-aware-lifecycle-manager-preparing-for-updates.adoc[leveloffset=+1]
...
include::ROOT:partial$cnf-topology-aware-lifecycle-manager-platform-update.adoc[leveloffset=+2]
...
include::ROOT:partial$cnf-topology-aware-lifecycle-manager-operator-update.adoc[leveloffset=+2]
...
include::ROOT:partial$cnf-topology-aware-lifecycle-manager-operator-and-platform-update.adoc[leveloffset=+2]

include::ROOT:partial$cnf-topology-aware-lifecycle-manager-pao-update.adoc[leveloffset=+2]

include::ROOT:partial$cnf-topology-aware-lifecycle-manager-autocreate-cgu-cr-ztp.adoc[leveloffset=+1]
