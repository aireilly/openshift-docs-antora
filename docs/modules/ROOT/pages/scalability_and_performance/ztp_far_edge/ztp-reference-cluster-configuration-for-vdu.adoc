...
include::ROOT:partial$ztp-low-latency.adoc[leveloffset=+1]

include::ROOT:partial$ztp-install-sno-hardware-reqs.adoc[leveloffset=+1]

include::ROOT:partial$ztp-du-host-firmware-requirements.adoc[leveloffset=+1]

include::ROOT:partial$ztp-managed-cluster-network-prereqs.adoc[leveloffset=+1]
...
include::ROOT:partial$ztp-sno-du-enabling-workload-partitioning.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-configuring-the-container-mountspace.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-enabling-sctp.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-accelerating-container-startup.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-enabling-kdump.adoc[leveloffset=+2]
...
include::ROOT:partial$ztp-sno-du-configuring-the-operators.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-subscribing-to-the-operators-needed-for-platform-configuration.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-configuring-logging-locally-and-forwarding.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-configuring-performance-addons.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-configuring-ptp.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-tuning-the-performance-patch.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-configuring-sriov.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-removing-the-console-operator.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-reducing-resource-usage-with-cluster-monitoring.adoc[leveloffset=+2]

include::ROOT:partial$ztp-sno-du-disabling-network-diagnostics.adoc[leveloffset=+2]
