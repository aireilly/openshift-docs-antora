...
include::ROOT:partial$ztp-generating-install-and-config-crs-manually.adoc[leveloffset=+1]
...
include::ROOT:partial$ztp-manually-install-a-single-managed-cluster.adoc[leveloffset=+1]
...
include::ROOT:partial$ztp-checking-the-managed-cluster-status.adoc[leveloffset=+1]

include::ROOT:partial$ztp-troubleshooting-the-managed-cluster.adoc[leveloffset=+1]

include::ROOT:partial$ztp-installation-crs.adoc[leveloffset=+1]
