...
include::ROOT:partial$ibm-z-managing-cpu-overcommitment.adoc[leveloffset=+1]
...
include::ROOT:partial$ibm-z-disable-thp.adoc[leveloffset=+1]

include::ROOT:partial$ibm-z-boost-networking-performance-with-rfs.adoc[leveloffset=+1]
...
include::ROOT:partial$ibm-z-choose-networking-setup.adoc[leveloffset=+1]
...
include::ROOT:partial$ibm-z-ensure-high-disk-performance-hyperpav.adoc[leveloffset=+1]
...
include::ROOT:partial$ibm-z-rhel-kvm-host-recommendations.adoc[leveloffset=+1]
