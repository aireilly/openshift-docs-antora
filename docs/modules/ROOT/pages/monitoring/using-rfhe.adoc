...
include::ROOT:partial$nw-rfhe-introduction.adoc[leveloffset=+1]

include::ROOT:partial$nw-rfhe-installing-operator-cli.adoc[leveloffset=+2]

include::ROOT:partial$nw-rfhe-installing-operator-web-console.adoc[leveloffset=+2]

include::ROOT:partial$hw-installing-amq-interconnect-messaging-bus.adoc[leveloffset=+1]
...
include::ROOT:partial$nw-rfhe-creating-bmc-event-sub.adoc[leveloffset=+2]

include::ROOT:partial$nw-rfhe-quering-redfish-hardware-event-subs.adoc[leveloffset=+2]

include::ROOT:partial$nw-rfhe-creating-hardware-event.adoc[leveloffset=+2]

include::ROOT:partial$cnf-rfhe-notifications-api-refererence.adoc[leveloffset=+1]
