...
include::ROOT:partial$monitoring-accessing-the-metrics-targets-page.adoc[leveloffset=+1]

// Searching and filtering metrics targets
include::ROOT:partial$monitoring-searching-and-filtering-metrics-targets.adoc[leveloffset=+1]

// Getting detailed information about metrics targets
include::ROOT:partial$monitoring-getting-detailed-information-about-a-target.adoc[leveloffset=+1]
