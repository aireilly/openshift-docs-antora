...
include::ROOT:partial$metering-cluster-capacity-examples.adoc[leveloffset=+1]

include::ROOT:partial$metering-cluster-usage-examples.adoc[leveloffset=+1]

include::ROOT:partial$metering-cluster-utilization-examples.adoc[leveloffset=+1]
