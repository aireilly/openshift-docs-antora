...
include::ROOT:partial$metering-install-prerequisites.adoc[leveloffset=+1]

include::ROOT:partial$metering-install-operator.adoc[leveloffset=+1]
...
include::ROOT:partial$metering-install-verify.adoc[leveloffset=+1]
