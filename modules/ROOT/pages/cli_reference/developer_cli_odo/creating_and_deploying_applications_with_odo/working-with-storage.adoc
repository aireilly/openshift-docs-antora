...
include::ROOT:partial$developer-cli-odo-adding-storage-to-a-specific-container.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-switching-between-ephemeral-and-persistent-storage.adoc[leveloffset=+1]
