...
include::ROOT:partial$developer-cli-odo-sample-applications-git.adoc[leveloffset=+1]
include::ROOT:partial$developer-cli-odo-sample-applications-binary.adoc[leveloffset=+1]
