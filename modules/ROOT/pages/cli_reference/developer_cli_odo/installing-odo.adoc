...
include::ROOT:partial$developer-cli-odo-installing-odo-on-linux.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-installing-odo-on-windows.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-installing-odo-on-macos.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-installing-odo-on-vs-code.adoc[leveloffset=+1]

include::ROOT:partial$developer-cli-odo-installing-odo-on-linux-rpm.adoc[leveloffset=+1]
