...
include::ROOT:partial$kubernetes-components.adoc[leveloffset=+1]

include::ROOT:partial$kubernetes-resources.adoc[leveloffset=+1]
...
include::ROOT:partial$kubernetes-conceptual-guidelines.adoc[leveloffset=+1]
