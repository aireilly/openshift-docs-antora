...
include::ROOT:partial$machineset-yaml-azure.adoc[leveloffset=+1]
...
include::ROOT:partial$machineset-azure-ephemeral-os.adoc[leveloffset=+1]

//Creating machines on Ephemeral OS disks by using machine sets
include::ROOT:partial$machineset-creating-azure-ephemeral-os.adoc[leveloffset=+1]

//Enabling customer-managed encryption keys for a machine set
include::ROOT:partial$machineset-customer-managed-encryption-azure.adoc[leveloffset=+1]

// Accelerated Networking for Microsoft Azure VMs
include::ROOT:partial$machineset-azure-accelerated-networking.adoc[leveloffset=+1]
...
include::ROOT:partial$machineset-azure-enabling-accelerated-networking-existing.adoc[leveloffset=+1]
