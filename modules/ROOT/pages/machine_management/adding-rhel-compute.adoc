...
include::ROOT:partial$rhel-compute-overview.adoc[leveloffset=+1]

include::ROOT:partial$rhel-compute-requirements.adoc[leveloffset=+1]
...
include::ROOT:partial$rhel-images-aws.adoc[leveloffset=+2]
...
include::ROOT:partial$rhel-preparing-playbook-machine.adoc[leveloffset=+1]

include::ROOT:partial$rhel-preparing-node.adoc[leveloffset=+1]

include::ROOT:partial$rhel-attaching-instance-aws.adoc[leveloffset=+1]
...
include::ROOT:partial$rhel-worker-tag.adoc[leveloffset=+1]

include::ROOT:partial$rhel-adding-node.adoc[leveloffset=+1]

include::ROOT:partial$installation-approve-csrs.adoc[leveloffset=+1]

include::ROOT:partial$rhel-ansible-parameters.adoc[leveloffset=+1]
