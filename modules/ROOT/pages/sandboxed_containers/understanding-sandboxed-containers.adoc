...
include::ROOT:partial$sandboxed-containers-supported-platforms.adoc[leveloffset=+1]
...
include::ROOT:partial$sandboxed-containers-common-terms.adoc[leveloffset=+1]
...
include::ROOT:partial$sandboxed-containers-building-blocks.adoc[leveloffset=+2]
include::ROOT:partial$sandboxed-containers-rhcos-extensions.adoc[leveloffset=+2]
...
include::ROOT:partial$sandboxed-containers-deploying-osc-with-other-ocp-components.adoc[leveloffset=+2]
.Additional resources
