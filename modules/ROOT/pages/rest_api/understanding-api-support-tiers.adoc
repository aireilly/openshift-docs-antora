...
include::ROOT:partial$api-support-tiers.adoc[leveloffset=+1]

include::ROOT:partial$api-support-tiers-mapping.adoc[leveloffset=+1]

include::ROOT:partial$api-support-deprecation-policy.adoc[leveloffset=+1]
