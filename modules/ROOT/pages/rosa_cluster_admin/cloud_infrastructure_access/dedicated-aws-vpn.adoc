...
include::ROOT:partial$dedicated-aws-vpn-creating.adoc[leveloffset=+1]
include::ROOT:partial$dedicated-aws-vpn-verifying.adoc[leveloffset=+1]
include::ROOT:partial$dedicated-aws-vpn-troubleshooting.adoc[leveloffset=+1]
