...
include::ROOT:partial$dedicated-aws-vpc-peering-terms.adoc[leveloffset=+1]
include::ROOT:partial$dedicated-aws-vpc-initiating-peering.adoc[leveloffset=+1]
...
include::ROOT:partial$dedicated-aws-vpc-accepting-peering.adoc[leveloffset=+1]
include::ROOT:partial$dedicated-aws-vpc-configuring-routing-tables.adoc[leveloffset=+1]
include::ROOT:partial$dedicated-aws-vpc-verifying-troubleshooting.adoc[leveloffset=+1]
