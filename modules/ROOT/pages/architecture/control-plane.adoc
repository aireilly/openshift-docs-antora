...
include::ROOT:partial$architecture-machine-config-pools.adoc[leveloffset=+1]
...
include::ROOT:partial$architecture-machine-roles.adoc[leveloffset=+1]

include::ROOT:partial$operators-overview.adoc[leveloffset=+1]

ifdef::openshift-enterprise,openshift-webscale,openshift-origin[]
include::ROOT:partial$arch-cluster-operators.adoc[leveloffset=+2]
...
include::ROOT:partial$arch-olm-operators.adoc[leveloffset=+2]
...
include::ROOT:partial$understanding-machine-config-operator.adoc[leveloffset=+1]
