...
====
include::ROOT:partial$rosa-sts-about-ocm-role.adoc[leveloffset=+1]
include::ROOT:partial$rosa-sts-ocm-role-creation.adoc[leveloffset=+2]
include::ROOT:partial$rosa-sts-about-user-role.adoc[leveloffset=+1]
include::ROOT:partial$rosa-sts-user-role-creation.adoc[leveloffset=+2]
include::ROOT:partial$rosa-sts-aws-requirements-association-concept.adoc[leveloffset=+1]
