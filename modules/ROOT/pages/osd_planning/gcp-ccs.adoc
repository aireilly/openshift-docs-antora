...
include::ROOT:partial$ccs-gcp-understand.adoc[leveloffset=+1]
include::ROOT:partial$ccs-gcp-customer-requirements.adoc[leveloffset=+1]
include::ROOT:partial$ccs-gcp-customer-procedure.adoc[leveloffset=+1]
include::ROOT:partial$ccs-gcp-iam.adoc[leveloffset=+1]
include::ROOT:partial$gcp-limits.adoc[leveloffset=+1]
