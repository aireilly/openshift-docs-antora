...
include::ROOT:partial$persistent-storage-vsphere-dynamic-provisioning.adoc[leveloffset=+2]

include::ROOT:partial$persistent-storage-vsphere-dynamic-provisioning-cli.adoc[leveloffset=+2]

include::ROOT:partial$persistent-storage-vsphere-static-provisioning.adoc[leveloffset=+1]

include::ROOT:partial$persistent-storage-vsphere-formatting.adoc[leveloffset=+2]
