...
include::ROOT:partial$understanding-pod-error-states.adoc[leveloffset=+1]

// Reviewing pod status
include::ROOT:partial$reviewing-pod-status.adoc[leveloffset=+1]

// Inspecting pod and container logs
include::ROOT:partial$inspecting-pod-and-container-logs.adoc[leveloffset=+1]

// Accessing running pods
include::ROOT:partial$accessing-running-pods.adoc[leveloffset=+1]

// Starting debug pods with root access
include::ROOT:partial$starting-debug-pods-with-root-access.adoc[leveloffset=+1]

// Copying files to and from pods and containers
include::ROOT:partial$copying-files-pods-and-containers.adoc[leveloffset=+1]
