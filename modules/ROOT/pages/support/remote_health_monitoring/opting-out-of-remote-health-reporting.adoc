...
include::ROOT:partial$telemetry-consequences-of-disabling-telemetry.adoc[leveloffset=+1]

include::ROOT:partial$insights-operator-new-pull-secret-disabled.adoc[leveloffset=+1]
