...
// kn flags
include::ROOT:partial$serverless-traffic-splitting-flags-kn.adoc[leveloffset=+1]
// creating custom URLs by using tags
include::ROOT:partial$serverless-custom-revision-urls.adoc[leveloffset=+2]
// kn CLI
include::ROOT:partial$serverless-create-traffic-split-kn.adoc[leveloffset=+1]

// ODC
include::ROOT:partial$odc-splitting-traffic-between-revisions-using-developer-perspective.adoc[leveloffset=+1]

// blue-green
include::ROOT:partial$serverless-blue-green-deploy.adoc[leveloffset=+1]
