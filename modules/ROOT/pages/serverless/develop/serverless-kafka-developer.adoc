...
include::ROOT:partial$serverless-kafka-event-delivery.adoc[leveloffset=+1]
...
// dev console
include::ROOT:partial$serverless-kafka-source-odc.adoc[leveloffset=+2]
// kn commands
...
// YAML
include::ROOT:partial$serverless-kafka-source-yaml.adoc[leveloffset=+2]

[id="serverless-kafka-developer-broker"]
== Kafka broker

include::ROOT:partial$serverless-about-kafka-broker.adoc[]
...
// Kafka sink
include::ROOT:partial$serverless-kafka-sink.adoc[leveloffset=+2]
