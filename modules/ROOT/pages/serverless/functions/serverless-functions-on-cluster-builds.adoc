...
include::ROOT:partial$serverless-functions-creating-on-cluster-builds.adoc[leveloffset=+1]
include::ROOT:partial$serverless-functions-specifying-function-revision.adoc[leveloffset=+1]
