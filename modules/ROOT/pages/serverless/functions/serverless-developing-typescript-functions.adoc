...
include::ROOT:partial$serverless-typescript-template.adoc[leveloffset=+1]
...
include::ROOT:partial$serverless-typescript-functions-context-objects.adoc[leveloffset=+2]
include::ROOT:partial$serverless-typescript-function-return-values.adoc[leveloffset=+1]
include::ROOT:partial$serverless-testing-typescript-functions.adoc[leveloffset=+1]
