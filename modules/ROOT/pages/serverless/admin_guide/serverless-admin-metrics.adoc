...
// Common metrics
include::ROOT:partial$serverless-controller-metrics.adoc[leveloffset=+1]
include::ROOT:partial$serverless-webhook-metrics.adoc[leveloffset=+1]
...
include::ROOT:partial$serverless-broker-ingress-metrics.adoc[leveloffset=+2]
include::ROOT:partial$serverless-broker-filter-metrics.adoc[leveloffset=+2]
include::ROOT:partial$serverless-inmemory-dispatch-metrics.adoc[leveloffset=+2]
include::ROOT:partial$serverless-event-source-metrics.adoc[leveloffset=+2]
...
include::ROOT:partial$serverless-activator-metrics.adoc[leveloffset=+2]
include::ROOT:partial$serverless-autoscaler-metrics.adoc[leveloffset=+2]
include::ROOT:partial$serverless-go-metrics.adoc[leveloffset=+2]
