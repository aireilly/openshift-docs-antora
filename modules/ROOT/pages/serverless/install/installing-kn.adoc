...
include::ROOT:partial$serverless-installing-cli-web-console.adoc[leveloffset=+1]
include::ROOT:partial$serverless-installing-cli-linux-rpm-package-manager.adoc[leveloffset=+1]
include::ROOT:partial$serverless-installing-cli-linux.adoc[leveloffset=+1]
include::ROOT:partial$serverless-installing-cli-macos.adoc[leveloffset=+1]
include::ROOT:partial$serverless-installing-cli-windows.adoc[leveloffset=+1]
