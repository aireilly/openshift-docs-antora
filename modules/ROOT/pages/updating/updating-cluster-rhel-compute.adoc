...
include::ROOT:partial$rhel-compute-about-hooks.adoc[leveloffset=+2]

include::ROOT:partial$rhel-compute-using-hooks.adoc[leveloffset=+2]

include::ROOT:partial$rhel-compute-available-hooks.adoc[leveloffset=+2]

include::ROOT:partial$rhel-compute-updating.adoc[leveloffset=+1]
