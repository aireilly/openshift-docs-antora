...
include::ROOT:partial$update-preparing-list.adoc[leveloffset=+1]
...
include::ROOT:partial$update-preparing-evaluate-alerts.adoc[leveloffset=+2]

// Using APIRequestCount to identify uses of removed APIs
include::ROOT:partial$update-preparing-evaluate-apirequestcount.adoc[leveloffset=+2]

// Using APIRequestCount to identify which workloads are using the removed APIs
include::ROOT:partial$update-preparing-evaluate-apirequestcount-workloads.adoc[leveloffset=+2]

// Migrating instances of removed APIs
include::ROOT:partial$update-preparing-migrate.adoc[leveloffset=+1]

// Providing the administrator acknowledgment
include::ROOT:partial$update-preparing-ack.adoc[leveloffset=+1]
