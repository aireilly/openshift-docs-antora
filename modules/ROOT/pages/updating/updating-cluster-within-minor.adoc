...
include::ROOT:partial$update-using-custom-machine-config-pools-canary.adoc[leveloffset=+1]
...
include::ROOT:partial$manually-maintained-credentials-upgrade.adoc[leveloffset=+1]
...
include::ROOT:partial$machine-health-checks-pausing-web-console.adoc[leveloffset=+1]

include::ROOT:partial$updating-sno.adoc[leveloffset=+1]
...
include::ROOT:partial$update-upgrading-web.adoc[leveloffset=+1]

include::ROOT:partial$update-changing-update-server-web.adoc[leveloffset=+1]
