...
include::ROOT:partial$update-upgrading-cli.adoc[leveloffset=+1]
...
include::ROOT:partial$update-conditional-updates.adoc[leveloffset=+1]
...
include::ROOT:partial$update-changing-update-server-cli.adoc[leveloffset=+1]
