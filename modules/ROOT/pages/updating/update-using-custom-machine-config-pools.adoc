...
include::ROOT:partial$update-using-custom-machine-config-pools-about.adoc[leveloffset=+1]
include::ROOT:partial$update-using-custom-machine-config-pools-mcp.adoc[leveloffset=+1]
include::ROOT:partial$update-using-custom-machine-config-pools-pause.adoc[leveloffset=+1]
...
include::ROOT:partial$update-using-custom-machine-config-pools-unpause.adoc[leveloffset=+1]

include::ROOT:partial$update-using-custom-machine-config-pools-mcp-remove.adoc[leveloffset=+1]
