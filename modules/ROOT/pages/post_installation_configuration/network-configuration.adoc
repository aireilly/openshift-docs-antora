...
include::ROOT:partial$nw-proxy-configure-object.adoc[leveloffset=+1]
...
include::ROOT:partial$nw-nodeport-service-range-edit.adoc[leveloffset=+3]
...
include::ROOT:partial$nw-networkpolicy-about.adoc[leveloffset=+2]
include::ROOT:partial$nw-networkpolicy-object.adoc[leveloffset=+2]
include::ROOT:partial$nw-networkpolicy-create.adoc[leveloffset=+2]
include::ROOT:partial$nw-networkpolicy-multitenant-isolation.adoc[leveloffset=+2]
...
include::ROOT:partial$modifying-template-for-new-projects.adoc[leveloffset=+2]

include::ROOT:partial$nw-networkpolicy-project-defaults.adoc[leveloffset=+3]
endif::[]

include::ROOT:partial$ossm-supported-configurations.adoc[leveloffset=+1]

include::ROOT:partial$ossm-installation-activities.adoc[leveloffset=+2]
...
include::ROOT:partial$baseline-router-performance.adoc[leveloffset=+2]

include::ROOT:partial$router-performance-optimizations.adoc[leveloffset=+2]
...
include::ROOT:partial$installation-osp-configuring-api-floating-ip.adoc[leveloffset=+2]
include::ROOT:partial$installation-osp-kuryr-port-pools.adoc[leveloffset=+2]
include::ROOT:partial$installation-osp-kuryr-settings-active.adoc[leveloffset=+2]
include::ROOT:partial$nw-osp-enabling-ovs-offload.adoc[leveloffset=+2]
