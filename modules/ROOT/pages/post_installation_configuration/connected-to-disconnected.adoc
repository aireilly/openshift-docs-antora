...
include::ROOT:partial$connected-to-disconnected-prepare-mirror.adoc[leveloffset=+1]
include::ROOT:partial$connected-to-disconnected-mirror-images.adoc[leveloffset=+1]
...
include::ROOT:partial$connected-to-disconnected-config-registry.adoc[leveloffset=+1]
include::ROOT:partial$connected-to-disconnected-verify.adoc[leveloffset=+1]
include::ROOT:partial$connected-to-disconnected-disconnect.adoc[leveloffset=+1]
...
include::ROOT:partial$connected-to-disconnected-restore-insights.adoc[leveloffset=+1]
include::ROOT:partial$connected-to-disconnected-restore.adoc[leveloffset=+1]
