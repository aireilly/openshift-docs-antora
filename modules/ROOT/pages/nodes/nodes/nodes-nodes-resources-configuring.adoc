...
include::ROOT:partial$nodes-nodes-resources-configuring-about.adoc[leveloffset=+1]

include::ROOT:partial$nodes-nodes-resources-configuring-auto.adoc[leveloffset=+1]

include::ROOT:partial$nodes-nodes-resources-configuring-setting.adoc[leveloffset=+1]
