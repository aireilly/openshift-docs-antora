...
include::ROOT:partial$nodes-nodes-jobs-about.adoc[leveloffset=+1]

include::ROOT:partial$nodes-nodes-jobs-creating.adoc[leveloffset=+1]

include::ROOT:partial$nodes-nodes-jobs-creating-cron.adoc[leveloffset=+1]
