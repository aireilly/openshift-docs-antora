...
include::ROOT:partial$nodes-pods-priority-about.adoc[leveloffset=+1]

include::ROOT:partial$nodes-pods-priority-preempt-about.adoc[leveloffset=+1]

include::ROOT:partial$nodes-pods-priority-configuring.adoc[leveloffset=+1]
