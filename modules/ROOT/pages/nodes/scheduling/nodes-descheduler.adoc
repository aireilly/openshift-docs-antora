...
include::ROOT:partial$nodes-descheduler-about.adoc[leveloffset=+1]
...
include::ROOT:partial$nodes-descheduler-configuring-profiles.adoc[leveloffset=+1]

// Configuring the descheduler interval
include::ROOT:partial$nodes-descheduler-configuring-interval.adoc[leveloffset=+1]

// Uninstalling the descheduler
include::ROOT:partial$nodes-descheduler-uninstalling.adoc[leveloffset=+1]
