...
include::ROOT:partial$nodes-scheduler-pod-affinity-about.adoc[leveloffset=+1]

include::ROOT:partial$nodes-scheduler-pod-affinity-configuring.adoc[leveloffset=+1]

include::ROOT:partial$nodes-scheduler-pod-anti-affinity-configuring.adoc[leveloffset=+1]

include::ROOT:partial$nodes-scheduler-pod-affinity-example.adoc[leveloffset=+1]
