...
include::ROOT:partial$nodes-scheduler-pod-topology-spread-constraints-about.adoc[leveloffset=+1]

// Configuring pod topology spread constraints
include::ROOT:partial$nodes-scheduler-pod-topology-spread-constraints-configuring.adoc[leveloffset=+1]

// Sample pod topology spread constraints
include::ROOT:partial$nodes-scheduler-pod-topology-spread-constraints-examples.adoc[leveloffset=+1]
