...
include::ROOT:partial$nodes-containers-events-about.adoc[leveloffset=+1]

include::ROOT:partial$nodes-containers-events-viewing.adoc[leveloffset=+1]

include::ROOT:partial$nodes-containers-events-list.adoc[leveloffset=+1]
