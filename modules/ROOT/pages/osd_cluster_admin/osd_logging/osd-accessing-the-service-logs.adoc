...
// Commented out while the OpenShift Cluster Manager CLI is in Developer Preview:
//include::ROOT:partial$viewing-the-service-logs.adoc[leveloffset=+1]
//include::ROOT:partial$viewing-the-service-logs-ocm.adoc[leveloffset=+2]
//include::ROOT:partial$viewing-the-service-logs-cli.adoc[leveloffset=+2]
include::ROOT:partial$viewing-the-service-logs-ocm.adoc[leveloffset=+1]
include::ROOT:partial$adding-cluster-notification-contacts.adoc[leveloffset=+1]
