...
include::ROOT:partial$osd-monitoring-understanding-metrics.adoc[leveloffset=+1]

// Setting up metrics collection for user-defined projects
include::ROOT:partial$osd-monitoring-setting-up-metrics-collection-for-user-defined-projects.adoc[leveloffset=+1]
include::ROOT:partial$osd-monitoring-deploying-a-sample-service.adoc[leveloffset=+2]
include::ROOT:partial$osd-monitoring-specifying-how-a-service-is-monitored.adoc[leveloffset=+2]
...
// Querying metrics
include::ROOT:partial$osd-monitoring-querying-metrics.adoc[leveloffset=+1]
include::ROOT:partial$osd-monitoring-querying-metrics-for-all-projects-as-an-administrator.adoc[leveloffset=+2]
include::ROOT:partial$osd-monitoring-querying-metrics-for-user-defined-projects-as-a-developer.adoc[leveloffset=+2]
...
include::ROOT:partial$osd-monitoring-exploring-the-visualized-metrics.adoc[leveloffset=+2]
