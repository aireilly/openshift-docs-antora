...
include::ROOT:partial$ossm-control-plane-web.adoc[leveloffset=+1]

include::ROOT:partial$ossm-control-plane-cli.adoc[leveloffset=+1]

include::ROOT:partial$ossm-validate-smcp-cli.adoc[leveloffset=+1]

include::ROOT:partial$ossm-validate-smcp-kiali.adoc[leveloffset=+1]

include::ROOT:partial$ossm-install-rosa.adoc[leveloffset=+1]
