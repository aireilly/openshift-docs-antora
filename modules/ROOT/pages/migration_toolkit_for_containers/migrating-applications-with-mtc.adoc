...
include::ROOT:partial$migration-prerequisites.adoc[leveloffset=+1]
...
include::ROOT:partial$migration-launching-cam.adoc[leveloffset=+2]
include::ROOT:partial$migration-adding-cluster-to-cam.adoc[leveloffset=+2]
include::ROOT:partial$migration-adding-replication-repository-to-cam.adoc[leveloffset=+2]
include::ROOT:partial$migration-creating-migration-plan-cam.adoc[leveloffset=+2]
...
include::ROOT:partial$migration-running-migration-plan-cam.adoc[leveloffset=+2]
