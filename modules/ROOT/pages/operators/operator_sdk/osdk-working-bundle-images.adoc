...
include::ROOT:partial$osdk-bundle-operator.adoc[leveloffset=+1]
include::ROOT:partial$osdk-deploy-olm.adoc[leveloffset=+1]
include::ROOT:partial$osdk-publish-catalog.adoc[leveloffset=+1]
...
include::ROOT:partial$osdk-bundle-upgrade-olm.adoc[leveloffset=+1]
...
include::ROOT:partial$osdk-control-compat.adoc[leveloffset=+1]
