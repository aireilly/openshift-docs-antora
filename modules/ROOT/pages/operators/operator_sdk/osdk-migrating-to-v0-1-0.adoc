...
include::ROOT:partial$creating-new-osdk-v0-1-0-project.adoc[leveloffset=+1]
include::ROOT:partial$migrating-custom-types-pkg-apis.adoc[leveloffset=+1]
include::ROOT:partial$migrating-reconcile-code.adoc[leveloffset=+1]
