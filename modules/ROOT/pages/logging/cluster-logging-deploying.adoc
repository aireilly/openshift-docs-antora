...
include::ROOT:partial$cluster-logging-deploy-console.adoc[leveloffset=+1]
...
include::ROOT:partial$cluster-logging-deploy-cli.adoc[leveloffset=+1]
...
include::ROOT:partial$cluster-logging-visualizer-indices.adoc[leveloffset=+2]

include::ROOT:partial$cluster-logging-deploy-multitenant.adoc[leveloffset=+2]
...
// include::ROOT:partial$cluster-logging-deploy-memory.adoc[leveloffset=+1]

// include::ROOT:partial$cluster-logging-deploy-certificates.adoc[leveloffset=+1]

// include::ROOT:partial$cluster-logging-deploy-label.adoc[leveloffset=+1]
