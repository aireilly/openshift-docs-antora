...
include::ROOT:partial$cluster-logging-elasticsearch-audit.adoc[leveloffset=+1]
...
include::ROOT:partial$cluster-logging-elasticsearch-retention.adoc[leveloffset=+1]

include::ROOT:partial$cluster-logging-logstore-limits.adoc[leveloffset=+1]

include::ROOT:partial$cluster-logging-elasticsearch-ha.adoc[leveloffset=+1]

include::ROOT:partial$cluster-logging-elasticsearch-scaledown.adoc[leveloffset=+1]

include::ROOT:partial$cluster-logging-elasticsearch-storage.adoc[leveloffset=+1]

include::ROOT:partial$cluster-logging-elasticsearch-persistent-storage-empty.adoc[leveloffset=+1]

include::ROOT:partial$cluster-logging-manual-rollout-rolling.adoc[leveloffset=+1]

include::ROOT:partial$cluster-logging-elasticsearch-exposing.adoc[leveloffset=+1]
