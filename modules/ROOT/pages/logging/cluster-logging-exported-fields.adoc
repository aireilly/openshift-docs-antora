...
include::ROOT:partial$cluster-logging-exported-fields-top-level-fields.adoc[leveloffset=0]

include::ROOT:partial$cluster-logging-exported-fields-kubernetes.adoc[leveloffset=0]
