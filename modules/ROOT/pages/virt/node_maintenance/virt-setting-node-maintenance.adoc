...
include::ROOT:partial$virt-setting-node-maintenance-web.adoc[leveloffset=+1]
include::ROOT:partial$virt-setting-node-maintenance-cli.adoc[leveloffset=+1]
include::ROOT:partial$virt-setting-node-to-maintenance-mode-with-cr.adoc[leveloffset=+1]
include::ROOT:partial$virt-checking_status_of_node_maintenance_cr_tasks.adoc[leveloffset=+2]
