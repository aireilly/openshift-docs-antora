...
include::ROOT:partial$virt-extended-selinux-policies-for-virt-launcher.adoc[leveloffset=+1]

include::ROOT:partial$virt-additional-scc-for-kubevirt-controller.adoc[leveloffset=+1]
