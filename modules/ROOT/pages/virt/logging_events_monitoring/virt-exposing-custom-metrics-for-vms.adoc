...
include::ROOT:partial$virt-configuring-node-exporter-service.adoc[leveloffset=+1]
include::ROOT:partial$virt-configuring-vm-with-node-exporter-service.adoc[leveloffset=+1]
include::ROOT:partial$virt-creating-custom-monitoring-label-for-vms.adoc[leveloffset=+1]
include::ROOT:partial$virt-querying-the-node-exporter-service-for-metrics.adoc[leveloffset=+2]
include::ROOT:partial$virt-creating-servicemonitor-resource-for-node-exporter.adoc[leveloffset=+1]
include::ROOT:partial$virt-accessing-node-exporter-outside-cluster.adoc[leveloffset=+2]
