...
include::ROOT:partial$virt-about-pci-passthrough.adoc[leveloffset=+1]
include::ROOT:partial$virt-adding-kernel-arguments-enable-iommu.adoc[leveloffset=+2]
include::ROOT:partial$virt-binding-devices-vfio-driver.adoc[leveloffset=+2]
include::ROOT:partial$virt-exposing-pci-device-in-cluster-cli.adoc[leveloffset=+2]
include::ROOT:partial$virt-removing-pci-device-from-cluster-cli.adoc[leveloffset=+2]
...
include::ROOT:partial$virt-assigning-pci-device-virtual-machine.adoc[leveloffset=+2]
