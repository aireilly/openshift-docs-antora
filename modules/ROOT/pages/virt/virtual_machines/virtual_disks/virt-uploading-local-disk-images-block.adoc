...
include::ROOT:partial$virt-about-block-pvs.adoc[leveloffset=+1]

include::ROOT:partial$virt-creating-local-block-pv.adoc[leveloffset=+1]

include::ROOT:partial$virt-creating-an-upload-dv.adoc[leveloffset=+1]

include::ROOT:partial$virt-uploading-local-disk-image-dv.adoc[leveloffset=+1]
