...
include::ROOT:partial$virt-creating-data-volumes-using-storage-api.adoc[leveloffset=+1]

include::ROOT:partial$virt-creating-data-volumes-using-pvc-api.adoc[leveloffset=+1]

include::ROOT:partial$virt-customizing-storage-profile.adoc[leveloffset=+1]
