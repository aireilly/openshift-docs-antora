...
include::ROOT:partial$virt-importing-rhel-image-boot-source-web.adoc[leveloffset=+1]

include::ROOT:partial$virt-adding-a-boot-source-web.adoc[leveloffset=+1]

include::ROOT:partial$virt-creating-a-vm-from-a-template-with-an-attached-boot-source.adoc[leveloffset=+1]

include::ROOT:partial$virt-creating-a-custom-image-boot-source-web.adoc[leveloffset=+1]
