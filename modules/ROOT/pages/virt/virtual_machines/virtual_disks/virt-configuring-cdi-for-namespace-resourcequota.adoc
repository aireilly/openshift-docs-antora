...
include::ROOT:partial$virt-about-cpu-and-memory-quota-namespace.adoc[leveloffset=+1]

include::ROOT:partial$virt-overriding-cpu-and-memory-defaults.adoc[leveloffset=+1]
