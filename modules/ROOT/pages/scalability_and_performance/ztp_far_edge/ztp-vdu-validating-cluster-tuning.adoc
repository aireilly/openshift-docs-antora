...
include::ROOT:partial$ztp-du-firmware-config-reference.adoc[leveloffset=+1]

include::ROOT:partial$ztp-du-cluster-config-reference.adoc[leveloffset=+1]

include::ROOT:partial$ztp-checking-kernel-rt-in-cluster.adoc[leveloffset=+2]

include::ROOT:partial$ztp-checking-du-cluster-config.adoc[leveloffset=+1]
