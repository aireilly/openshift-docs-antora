...
include::ROOT:partial$about-bare-metal-hosts-and-nodes.adoc[leveloffset=+1]
include::ROOT:partial$maintaining-bare-metal-hosts.adoc[leveloffset=+1]
...
include::ROOT:partial$adding-bare-metal-host-to-cluster-using-web-console.adoc[leveloffset=+2]
include::ROOT:partial$adding-bare-metal-host-to-cluster-using-yaml.adoc[leveloffset=+2]
include::ROOT:partial$automatically-scaling-machines-to-available-bare-metal-hosts.adoc[leveloffset=+2]
include::ROOT:partial$removing-bare-metal-hosts-from-provisioner.adoc[leveloffset=+2]
