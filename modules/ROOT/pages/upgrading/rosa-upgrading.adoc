...
include::ROOT:partial$rosa-upgrading-cli-tutorial.adoc[leveloffset=+2]
include::ROOT:partial$rosa-upgrading-manual-ocm.adoc[leveloffset=+2]
include::ROOT:partial$rosa-upgrading-automatic-ocm.adoc[leveloffset=+2]
