...
include::ROOT:partial$identity-provider-htpasswd-about.adoc[leveloffset=+1]
...
include::ROOT:partial$identity-provider-creating-htpasswd-file-linux.adoc[leveloffset=+2]

include::ROOT:partial$identity-provider-creating-htpasswd-file-windows.adoc[leveloffset=+2]

include::ROOT:partial$identity-provider-htpasswd-secret.adoc[leveloffset=+1]

include::ROOT:partial$identity-provider-htpasswd-CR.adoc[leveloffset=+1]
...
include::ROOT:partial$identity-provider-htpasswd-update-users.adoc[leveloffset=+1]
