...
include::ROOT:partial$monitoring-reviewing-monitoring-dashboards-admin.adoc[leveloffset=+1]

// Reviewing monitoring dashboards as a developer
include::ROOT:partial$monitoring-reviewing-monitoring-dashboards-developer.adoc[leveloffset=+1]
