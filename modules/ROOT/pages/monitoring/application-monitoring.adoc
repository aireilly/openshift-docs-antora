...
include::ROOT:partial$monitoring-configuring-cluster-for-application-monitoring.adoc[leveloffset=+1]
include::ROOT:partial$monitoring-configuring-monitoring-for-an-application.adoc[leveloffset=+1]
include::ROOT:partial$monitoring-exposing-custom-application-metrics-for-horizontal-pod-autoscaling.adoc[leveloffset=+1]
