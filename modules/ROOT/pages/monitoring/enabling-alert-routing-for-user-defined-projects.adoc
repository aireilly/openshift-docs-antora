...
include::ROOT:partial$monitoring-understanding-alert-routing-for-user-defined-projects.adoc[leveloffset=+1]

// Enabling alert routing for user-defined projects
include::ROOT:partial$monitoring-enabling-alert-routing-for-user-defined-projects.adoc[leveloffset=+1]

// Granting users permission to configure alert routing for user-defined projects
include::ROOT:partial$monitoring-granting-users-permission-to-configure-alert-routing-for-user-defined-projects.adoc[leveloffset=+1]

// Disabling alert routing for user-defined projects
include::ROOT:partial$monitoring-disabling-alert-routing-for-user-defined-projects.adoc[leveloffset=+1]
