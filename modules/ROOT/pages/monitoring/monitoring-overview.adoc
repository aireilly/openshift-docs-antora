...
include::ROOT:partial$monitoring-understanding-the-monitoring-stack.adoc[leveloffset=+1]
include::ROOT:partial$monitoring-default-monitoring-components.adoc[leveloffset=+2]
include::ROOT:partial$monitoring-default-monitoring-targets.adoc[leveloffset=+2]
include::ROOT:partial$monitoring-components-for-monitoring-user-defined-projects.adoc[leveloffset=+2]
include::ROOT:partial$monitoring-targets-for-user-defined-projects.adoc[leveloffset=+2]
include::ROOT:partial$monitoring-common-terms.adoc[leveloffset=+1]
