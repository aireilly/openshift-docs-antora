...
include::ROOT:partial$sbo-configuration-of-directory-path-to-project-binding-data.adoc[leveloffset=+1]
include::ROOT:partial$sbo-projecting-the-binding-data.adoc[leveloffset=+1]
