...
// Cluster events
include::ROOT:partial$security-monitoring-events.adoc[leveloffset=+1]

// Logging
include::ROOT:partial$security-monitoring-cluster-logging.adoc[leveloffset=+1]

// Audit logging
include::ROOT:partial$security-monitoring-audit-logging.adoc[leveloffset=+1]
