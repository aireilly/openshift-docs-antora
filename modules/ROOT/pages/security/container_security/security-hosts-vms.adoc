...
include::ROOT:partial$security-hosts-vms-rhcos.adoc[leveloffset=+1]
...
include::ROOT:partial$security-hosts-vms-vs-containers.adoc[leveloffset=+1]

// Securing OpenShift
include::ROOT:partial$security-hosts-vms-openshift.adoc[leveloffset=+1]
