...
include::ROOT:partial$containers-signature-verify-enable.adoc[leveloffset=+1]

//Verifying that the enable signature verification is active
include::ROOT:partial$containers-signature-verify-application.adoc[leveloffset=+1]
