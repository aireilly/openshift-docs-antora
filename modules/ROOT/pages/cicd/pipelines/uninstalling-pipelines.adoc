...
include::ROOT:partial$op-deleting-the-pipelines-component-and-custom-resources.adoc[leveloffset=+1]

include::ROOT:partial$op-uninstalling-the-pipelines-operator.adoc[leveloffset=+1]
