...
include::ROOT:partial$op-understanding-credential-selection.adoc[leveloffset=+1]

include::ROOT:partial$op-configuring-basic-authentication-for-git.adoc[leveloffset=+1]

include::ROOT:partial$op-configuring-ssh-authentication-for-git.adoc[leveloffset=+1]

include::ROOT:partial$op-using-ssh-authentication-in-git-type-tasks.adoc[leveloffset=+1]

include::ROOT:partial$op-using-secrets-as-a-nonroot-user.adoc[leveloffset=+1]

include::ROOT:partial$op-limiting-secret-access-to-specific-steps.adoc[leveloffset=+1]
