...
include::ROOT:partial$op-understanding-pipelines-resource-consumption.adoc[leveloffset=+1]

include::ROOT:partial$op-mitigating-extra-pipeline-resource-consumption.adoc[leveloffset=+1]
