...
//About tasks
include::ROOT:partial$op-about-tasks.adoc[leveloffset=+2]
//About when expression
include::ROOT:partial$op-about-whenexpression.adoc[leveloffset=+2]
//About final tasks
include::ROOT:partial$op-about-finally_tasks.adoc[leveloffset=+2]
//About task run
include::ROOT:partial$op-about-taskrun.adoc[leveloffset=+2]
//About pipelines
include::ROOT:partial$op-about-pipelines.adoc[leveloffset=+2]
//About pipeline run
include::ROOT:partial$op-about-pipelinerun.adoc[leveloffset=+2]
//About workspace
include::ROOT:partial$op-about-workspace.adoc[leveloffset=+2]
//About triggers
include::ROOT:partial$op-about-triggers.adoc[leveloffset=+2]
