...
include::ROOT:partial$op-alternative-approaches-compute-resource-quota-pipelines.adoc[leveloffset=+1]
...
include::ROOT:partial$op-specifying-pipelines-resource-quota-using-priority-class.adoc[leveloffset=+1]
