...
include::ROOT:partial$op-installing-and-deploying-tekton-hub-on-an-openshift-cluster.adoc[leveloffset=+1]

include::ROOT:partial$op-manually-refreshing-the-catalog-in-tekton-hub.adoc[leveloffset=+2]

include::ROOT:partial$op-setting-a-cron-job-for-refreshing-catalog-in-tekton-hub.adoc[leveloffset=+2]

include::ROOT:partial$op-adding-new-users-in-tekton-hub-configuration.adoc[leveloffset=+2]

include::ROOT:partial$op-opting-out-of-tekton-hub-in-the-developer-perspective.adoc[leveloffset=+1]
