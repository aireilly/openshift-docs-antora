...
include::ROOT:partial$migration-compatibility-guidelines.adoc[leveloffset=+1]
include::ROOT:partial$migration-installing-legacy-operator.adoc[leveloffset=+1]
include::ROOT:partial$migration-installing-mtc-on-ocp-4.adoc[leveloffset=+1]
include::ROOT:partial$migration-about-configuring-proxies.adoc[leveloffset=+1]
include::ROOT:partial$migration-configuring-proxies.adoc[leveloffset=+2]
...
include::ROOT:partial$migration-configuring-mcg.adoc[leveloffset=+2]
include::ROOT:partial$migration-configuring-aws-s3.adoc[leveloffset=+2]
include::ROOT:partial$migration-configuring-gcp.adoc[leveloffset=+2]
include::ROOT:partial$migration-configuring-azure.adoc[leveloffset=+2]
...
include::ROOT:partial$migration-uninstalling-mtc-clean-up.adoc[leveloffset=+1]
:installing-3-4!:
