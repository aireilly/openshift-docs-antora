...
include::ROOT:partial$registry-accessing-directly.adoc[leveloffset=+1]

ifdef::openshift-enterprise,openshift-webscale,openshift-origin[]
include::ROOT:partial$registry-checking-the-status-of-registry-pods.adoc[leveloffset=+1]

include::ROOT:partial$registry-viewing-logs.adoc[leveloffset=+1]

include::ROOT:partial$registry-accessing-metrics.adoc[leveloffset=+1]
