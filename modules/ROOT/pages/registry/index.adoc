...
include::ROOT:partial$registry-common-terms.adoc[leveloffset=+1]
include::ROOT:partial$registry-integrated-openshift-registry.adoc[leveloffset=+1]
...
include::ROOT:partial$registry-third-party-registries.adoc[leveloffset=+1]

include::ROOT:partial$registry-quay-overview.adoc[leveloffset=+1]
...
include::ROOT:partial$registry-authentication-enabled-registry-overview.adoc[leveloffset=+1]
