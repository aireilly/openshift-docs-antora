...
include::ROOT:partial$about-administrator-perspective.adoc[leveloffset=+1]
...
include::ROOT:partial$about-developer-perspective.adoc[leveloffset=+1]
include::ROOT:partial$odc-accessing-perspectives.adoc[leveloffset=+1]
