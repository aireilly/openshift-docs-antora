...
include::ROOT:partial$ocm-accessing.adoc[leveloffset=+1]
...
include::ROOT:partial$ocm-overview-tab.adoc[leveloffset=+2]
include::ROOT:partial$ocm-accesscontrol-tab.adoc[leveloffset=+2]
include::ROOT:partial$ocm-addons-tab.adoc[leveloffset=+2]
include::ROOT:partial$ocm-networking-tab-concept.adoc[leveloffset=+2]
ifndef::openshift-rosa[]
include::ROOT:partial$ocm-networking-tab-adding-ingress.adoc[leveloffset=+3]
endif::openshift-rosa[]
include::ROOT:partial$ocm-insightsadvisor-tab.adoc[leveloffset=+2]
include::ROOT:partial$ocm-machinepools-tab.adoc[leveloffset=+2]
include::ROOT:partial$ocm-support-tab.adoc[leveloffset=+2]
include::ROOT:partial$ocm-settings-tab.adoc[leveloffset=+2]
