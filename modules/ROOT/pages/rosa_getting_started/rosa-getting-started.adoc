...
include::ROOT:partial$rosa-getting-started-environment-setup.adoc[leveloffset=+1]
include::ROOT:partial$rosa-getting-started-enable-rosa.adoc[leveloffset=+2]
include::ROOT:partial$rosa-getting-started-install-configure-cli-tools.adoc[leveloffset=+2]
include::ROOT:partial$rosa-getting-started-verify-elb-role.adoc[leveloffset=+2]
include::ROOT:partial$rosa-getting-started-verify-aws-quota.adoc[leveloffset=+2]
...
include::ROOT:partial$rosa-getting-started-create-cluster-admin-user.adoc[leveloffset=+1]
...
include::ROOT:partial$rosa-getting-started-configure-an-idp-and-grant-access.adoc[leveloffset=+1]
include::ROOT:partial$rosa-getting-started-configure-an-idp.adoc[leveloffset=+2]
...
include::ROOT:partial$rosa-getting-started-grant-user-access.adoc[leveloffset=+2]
include::ROOT:partial$rosa-getting-started-grant-admin-privileges.adoc[leveloffset=+2]
include::ROOT:partial$rosa-getting-started-access-cluster-web-console.adoc[leveloffset=+1]
include::ROOT:partial$deploy-app.adoc[leveloffset=+1]
include::ROOT:partial$rosa-getting-started-revoking-admin-privileges-and-user-access.adoc[leveloffset=+1]
include::ROOT:partial$rosa-getting-started-revoke-admin-privileges.adoc[leveloffset=+2]
include::ROOT:partial$rosa-getting-started-revoke-user-access.adoc[leveloffset=+2]
include::ROOT:partial$rosa-getting-started-deleting-a-cluster.adoc[leveloffset=+1]
