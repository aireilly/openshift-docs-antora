...
include::ROOT:partial$installation-azure-stack-hub-network-config.adoc[leveloffset=+2]
...
include::ROOT:partial$installation-azure-stack-hub-permissions.adoc[leveloffset=+2]
...
include::ROOT:partial$installation-azure-stack-hub-config-yaml.adoc[leveloffset=+2]
