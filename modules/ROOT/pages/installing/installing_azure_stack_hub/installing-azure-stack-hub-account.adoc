...
include::ROOT:partial$installation-azure-stack-hub-network-config.adoc[leveloffset=+1]

include::ROOT:partial$installation-azure-stack-hub-permissions.adoc[leveloffset=+1]
