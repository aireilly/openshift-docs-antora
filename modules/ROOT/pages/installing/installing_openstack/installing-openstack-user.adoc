...
include::ROOT:partial$installation-osp-default-deployment.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-osp-config-yaml.adoc[leveloffset=+2]
...
include::ROOT:partial$installation-osp-deploying-bare-metal-machines.adoc[leveloffset=+2]
