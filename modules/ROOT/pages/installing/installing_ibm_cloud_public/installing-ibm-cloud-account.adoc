...
include::ROOT:partial$quotas-and-limits-ibm-cloud.adoc[leveloffset=+1]

include::ROOT:partial$installation-cis-ibm-cloud.adoc[leveloffset=+1]

include::ROOT:partial$installation-ibm-cloud-iam-policies-api-key.adoc[leveloffset=+1]
include::ROOT:partial$installation-ibm-cloud-creating-api-key.adoc[leveloffset=+2]

include::ROOT:partial$installation-ibm-cloud-regions.adoc[leveloffset=+1]
