...
include::ROOT:partial$minimum-ibm-z-system-requirements.adoc[leveloffset=+2]
include::ROOT:partial$preferred-ibm-z-system-requirements.adoc[leveloffset=+2]
...
include::ROOT:partial$installation-ibm-z-user-infra-machines-iso.adoc[leveloffset=+1]
