...
include::ROOT:partial$manually-creating-alibaba-manifests.adoc[leveloffset=+2]

include::ROOT:partial$cco-ccoctl-creating-at-once.adoc[leveloffset=+2]

include::ROOT:partial$installation-configuration-parameters.adoc[leveloffset=+2]

include::ROOT:partial$installation-alibaba-config-yaml.adoc[leveloffset=+2]
