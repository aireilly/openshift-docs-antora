...
include::ROOT:partial$installation-about-mirror-registry.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-adding-registry-pull-secret.adoc[leveloffset=+1]
...
include::ROOT:partial$installation-mirror-repository.adoc[leveloffset=+1]
...
include::ROOT:partial$olm-mirroring-catalog.adoc[leveloffset=+1]
...
include::ROOT:partial$olm-mirroring-catalog-extracting.adoc[leveloffset=+2]
include::ROOT:partial$olm-mirroring-catalog-colocated.adoc[leveloffset=+3]
...
include::ROOT:partial$olm-mirroring-catalog-airgapped.adoc[leveloffset=+3]

[role="_additional-resources"]
.Additional resources
* xref:operators/operator_sdk/osdk-generating-csvs.adoc#olm-arch-os-support_osdk-generating-csvs[Architecture and operating system support for Operators]

include::ROOT:partial$olm-mirroring-catalog-manifests.adoc[leveloffset=+2]
include::ROOT:partial$olm-mirroring-catalog-post.adoc[leveloffset=+2]
