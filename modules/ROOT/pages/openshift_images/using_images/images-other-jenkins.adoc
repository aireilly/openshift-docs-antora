...
include::ROOT:partial$images-other-jenkins-oauth-auth.adoc[leveloffset=+2]

include::ROOT:partial$images-other-jenkins-auth.adoc[leveloffset=+2]

include::ROOT:partial$images-other-jenkins-env-var.adoc[leveloffset=+1]

include::ROOT:partial$images-other-jenkins-cross-project.adoc[leveloffset=+1]
...
include::ROOT:partial$images-other-jenkins-customize-s2i.adoc[leveloffset=+1]

include::ROOT:partial$images-other-jenkins-config-kubernetes.adoc[leveloffset=+1]

include::ROOT:partial$images-other-jenkins-permissions.adoc[leveloffset=+1]

include::ROOT:partial$images-other-jenkins-create-service.adoc[leveloffset=+1]

include::ROOT:partial$images-other-jenkins-kubernetes-plugin.adoc[leveloffset=+1]

include::ROOT:partial$images-other-jenkins-memory.adoc[leveloffset=+1]
