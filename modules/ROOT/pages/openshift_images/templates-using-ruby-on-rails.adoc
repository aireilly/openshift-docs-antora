...
include::ROOT:partial$templates-rails-setting-up-database.adoc[leveloffset=+1]

include::ROOT:partial$templates-rails-writing-application.adoc[leveloffset=+1]

include::ROOT:partial$templates-rails-creating-welcome-page.adoc[leveloffset=+2]

include::ROOT:partial$templates-rails-configuring-application.adoc[leveloffset=+2]

include::ROOT:partial$templates-rails-storing-application-in-git.adoc[leveloffset=+2]

include::ROOT:partial$templates-rails-deploying-application.adoc[leveloffset=+1]

include::ROOT:partial$templates-rails-creating-database-service.adoc[leveloffset=+2]

include::ROOT:partial$templates-rails-creating-frontend-service.adoc[leveloffset=+2]

include::ROOT:partial$templates-rails-creating-route-for-application.adoc[leveloffset=+2]
