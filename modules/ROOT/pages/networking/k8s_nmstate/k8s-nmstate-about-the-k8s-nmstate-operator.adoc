...
include::ROOT:partial$k8s-nmstate-installing-the-kubernetes-nmstate-operator.adoc[leveloffset=+2]
include::ROOT:partial$k8s-nmstate-deploying-nmstate-CLI.adoc[leveloffset=+2]
