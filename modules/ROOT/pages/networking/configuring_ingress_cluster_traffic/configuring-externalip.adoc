...
include::ROOT:partial$nw-externalip-about.adoc[leveloffset=+1]

include::ROOT:partial$nw-externalip-object.adoc[leveloffset=+1]

include::ROOT:partial$nw-externalip-configuring.adoc[leveloffset=+1]
