...
include::ROOT:partial$nw-metallb-bgppeer-cr.adoc[leveloffset=+1]

// Add a BGP peer
include::ROOT:partial$nw-metallb-configure-bgppeer.adoc[leveloffset=+1]
...
// Examples
include::ROOT:partial$nw-metallb-example-bgppeer.adoc[leveloffset=+1]
