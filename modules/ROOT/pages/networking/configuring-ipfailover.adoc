...
include::ROOT:partial$nw-ipfailover-environment-variables.adoc[leveloffset=+1]

include::ROOT:partial$nw-ipfailover-configuration.adoc[leveloffset=+1]

include::ROOT:partial$nw-ipfailover-virtual-ip-addresses-concept.adoc[leveloffset=+1]

include::ROOT:partial$nw-ipfailover-configuring-check-notify-scripts.adoc[leveloffset=+1]

include::ROOT:partial$nw-ipfailover-configuring-vrrp-preemption.adoc[leveloffset=+1]

//Omitted the following procedure for now. We can update it to use `oc debug` if needed.
//include::ROOT:partial$nw-ipfailover-configuring-keepalived-multicast.adoc[leveloffset=+1]

include::ROOT:partial$nw-ipfailover-vrrp-ip-offset.adoc[leveloffset=+1]

include::ROOT:partial$nw-ipfailover-configuring-more-than-254.adoc[leveloffset=+1]

include::ROOT:partial$nw-ipfailover-cluster-ha-ingress.adoc[leveloffset=+1]

include::ROOT:partial$nw-ipfailover-remove.adoc[leveloffset=+1]
