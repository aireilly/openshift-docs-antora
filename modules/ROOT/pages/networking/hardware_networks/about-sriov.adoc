...
include::ROOT:partial$nw-sriov-supported-platforms.adoc[leveloffset=+2]
include::ROOT:partial$nw-sriov-supported-devices.adoc[leveloffset=+2]
include::ROOT:partial$nw-sriov-device-discovery.adoc[leveloffset=+2]
include::ROOT:partial$nw-sriov-example-vf-function-in-pod.adoc[leveloffset=+2]
include::ROOT:partial$nw-sriov-app-netutil.adoc[leveloffset=+2]
include::ROOT:partial$nw-sriov-huge-pages.adoc[leveloffset=+2]
