...
include::ROOT:partial$nw-sriov-dpdk-example-intel.adoc[leveloffset=+1]

include::ROOT:partial$nw-sriov-dpdk-example-mellanox.adoc[leveloffset=+1]
...
include::ROOT:partial$nw-sriov-rdma-example-mellanox.adoc[tag=content]
