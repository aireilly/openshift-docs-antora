...
include::ROOT:partial$nw-networkpolicy-audit-concept.adoc[leveloffset=+1]
...
include::ROOT:partial$nw-operator-cr.adoc[tag=policy-audit]

include::ROOT:partial$nw-networkpolicy-audit-configure.adoc[leveloffset=+1]
include::ROOT:partial$nw-networkpolicy-audit-enable.adoc[leveloffset=+1]
include::ROOT:partial$nw-networkpolicy-audit-disable.adoc[leveloffset=+1]
