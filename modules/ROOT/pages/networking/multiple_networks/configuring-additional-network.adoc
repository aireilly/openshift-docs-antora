...
include::ROOT:partial$nw-multus-bridge-object.adoc[leveloffset=+2]
include::ROOT:partial$nw-multus-host-device-object.adoc[leveloffset=+2]
include::ROOT:partial$nw-multus-ipvlan-object.adoc[leveloffset=+2]
include::ROOT:partial$nw-multus-macvlan-object.adoc[leveloffset=+2]

include::ROOT:partial$nw-multus-ipam-object.adoc[leveloffset=+1]

include::ROOT:partial$nw-multus-create-network.adoc[leveloffset=+1]

include::ROOT:partial$nw-multus-create-network-apply.adoc[leveloffset=+1]
