...
include::ROOT:partial$nw-ovn-kubernetes-features.adoc[leveloffset=+1]

include::ROOT:partial$nw-ovn-kubernetes-matrix.adoc[leveloffset=+1]
// This is a moving target; what is included isn't valid for 4.6
//include::ROOT:partial$nw-ovn-kubernetes-metrics.adoc[leveloffset=+1]

include::ROOT:partial$nw-ovn-kuberentes-limitations.adoc[leveloffset=+1]
