...
include::ROOT:partial$nw-network-flows-object.adoc[leveloffset=+1]

include::ROOT:partial$nw-network-flows-create.adoc[leveloffset=+1]

include::ROOT:partial$nw-network-flows-delete.adoc[leveloffset=+1]
