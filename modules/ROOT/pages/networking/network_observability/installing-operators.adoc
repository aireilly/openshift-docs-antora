...
include::ROOT:partial$network-observability-loki-install.adoc[leveloffset=+1]
include::ROOT:partial$network-observability-lokistack-create.adoc[leveloffset=+2]
include::ROOT:partial$network-observability-lokistack-ingestion-query.adoc[leveloffset=+2]
include::ROOT:partial$network-observability-roles-create.adoc[leveloffset=+1]
include::ROOT:partial$network-observability-kafka-option.adoc[leveloffset=+1]
include::ROOT:partial$network-observability-operator-install.adoc[leveloffset=+1]
...
include::ROOT:partial$network-observability-operator-uninstall.adoc[leveloffset=+1]
