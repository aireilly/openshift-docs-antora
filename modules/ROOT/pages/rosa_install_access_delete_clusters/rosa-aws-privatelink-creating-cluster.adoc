...
include::ROOT:partial$osd-aws-privatelink-about.adoc[leveloffset=+1]
include::ROOT:partial$osd-aws-privatelink-required-resources.adoc[leveloffset=+1]
include::ROOT:partial$rosa-aws-privatelink-create-cluster.adoc[leveloffset=+1]
include::ROOT:partial$osd-aws-privatelink-config-dns-forwarding.adoc[leveloffset=+1]
